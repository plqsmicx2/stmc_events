...
# kill item drops
execute in stmc:trials/replicate run kill @e[type=item]
...
function stmc:games/trials/replicate/round_active/round_end with storage stmc:global

# <===== RED RACCOONS =====>

execute unless score replicate.RedRaccoons replicate.completed matches 1 run function stmc:games/trials/replicate/round_active/red_raccoons

# <===== ORANGE OTTERS =====>

execute unless score replicate.OrangeOtters replicate.completed matches 1 run function stmc:games/trials/replicate/round_active/orange_otters

# <===== PINK PIKAS =====>

execute unless score replicate.PinkPikas replicate.completed matches 1 run function stmc:games/trials/replicate/round_active/pink_pikas

# <===== YELLOW YAKS =====>

execute unless score replicate.YellowYaks replicate.completed matches 1 run function stmc:games/trials/replicate/round_active/yellow_yaks

# <===== GREEN GOATS =====>

execute unless score replicate.GreenGoats replicate.completed matches 1 run function stmc:games/trials/replicate/round_active/green_goats

# <===== CYAN COUGARS =====>

execute unless score replicate.CyanCougars replicate.completed matches 1 run function stmc:games/trials/replicate/round_active/cyan_cougars

# <===== PURPLE PENGUINS =====>

execute unless score replicate.PurplePenguins replicate.completed matches 1 run function stmc:games/trials/replicate/round_active/purple_penguins

# <===== BLUE BEARS =====>

execute unless score replicate.BlueBears replicate.completed matches 1 run function stmc:games/trials/replicate/round_active/blue_bears