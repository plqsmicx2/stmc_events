...
# teleport players
execute in stmc:trials/replicate as @a[team=RED_RACCOONS] run tp @s 45 105 64 90 0
execute in stmc:trials/replicate as @a[team=ORANGE_OTTERS] run tp @s 45 105 21 90 0
execute in stmc:trials/replicate as @a[team=PINK_PIKAS] run tp @s 45 105 -22 90 0
execute in stmc:trials/replicate as @a[team=YELLOW_YAKS] run tp @s 45 105 -65 90 0
execute in stmc:trials/replicate as @a[team=GREEN_GOATS] run tp @s -45 105 -65 -90 0
execute in stmc:trials/replicate as @a[team=CYAN_COUGARS] run tp @s -45 105 -22 -90 0
execute in stmc:trials/replicate as @a[team=PURPLE_PENGUINS] run tp @s -45 105 21 -90 0
execute in stmc:trials/replicate as @a[team=BLUE_BEARS] run tp @s -45 105 64 -90 0

# make sure region is loaded
execute in stmc:trials/replicate run forceload add -80 -150 80 150
...
# kill all entities
execute in stmc:trials/replicate run kill @e[type=!player]
