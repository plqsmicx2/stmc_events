...
execute if score solve.handler solve.stage matches 3..4 run function stmc:games/solve/points_update
function stmc:games/solve/sidebar with storage stmc:global
...
# reset world
execute in stmc:solve if score solve.handler solve.timer.delay1 matches 3 run forceload add 0 0 120 120
execute in stmc:solve if score solve.handler solve.timer.delay1 matches 3 run kill @e[type=item]
execute in stmc:solve if score solve.handler solve.timer.delay1 matches 5..15 run function stmc:games/solve/reset_world
...
execute if score solve.handler solve.stage matches 1 run function stmc:games/solve/explanation
...
execute if score solve.handler solve.stage matches 3 run function stmc:games/solve/game_active/game_tick
...
execute if score solve.handler solve.timer.delay3 matches 100 run function stmc:games/solve/room_announcements
execute if score solve.handler solve.timer.delay3 matches 300 run function stmc:games/solve/team_announcements
execute if score solve.handler solve.stage matches 4 if score solve.handler solve.timer.delay3 matches 400.. run function stmc:games/solve/reset