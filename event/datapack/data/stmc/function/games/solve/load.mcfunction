...
execute in stmc:solve run tp @a 5 100 50
execute in stmc:solve run tp @a[team=RED_RACCOONS] 5 94 6
execute in stmc:solve run tp @a[team=ORANGE_OTTERS] 5 94 26
execute in stmc:solve run tp @a[team=PINK_PIKAS] 5 94 46
execute in stmc:solve run tp @a[team=GREEN_GOATS] 5 94 66
execute in stmc:solve run tp @a[team=CYAN_COUGARS] 5 94 86
execute in stmc:solve run tp @a[team=PURPLE_PENGUINS] 5 94 106
execute in stmc:solve run tp @a[team=YELLOW_YAKS] 5 94 126
execute in stmc:solve run tp @a[team=BLUE_BEARS] 5 94 146
...
# kill all entities
execute in stmc:solve run kill @e[type=!player]
...
function stmc:games/solve/points_update
