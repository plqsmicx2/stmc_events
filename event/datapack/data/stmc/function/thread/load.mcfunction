...
data modify storage stmc:global redName set value "Red Rabbis"
data modify storage stmc:global orangeName set value "Seamen"
data modify storage stmc:global pinkName set value "Pink Tips"
data modify storage stmc:global yellowName set value "Air Bud"
...
scoreboard objectives add stats.activeGame dummy
...
scoreboard players reset brawl.handler brawl.stage
