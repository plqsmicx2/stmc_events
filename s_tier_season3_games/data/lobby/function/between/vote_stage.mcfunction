...
execute if score lobby.handler lobby.timer.voteStage matches 699 in lobby:lobby run \
        kill @e[type=item]
execute if score lobby.handler lobby.timer.voteStage matches 699 in lobby:lobby run \
...
execute if score lobby.handler lobby.timer.voteStage matches 725 run function lobby:between/determine_vote
...
execute if score lobby.handler lobby.timer.voteStage matches 865 run gamerule keepInventory false
...
execute if score lobby.handler lobby.timer.voteStage matches 862 in lobby:lobby as @e[type=item] if items entity @s container.0 lime_wool \
        run setblock ~ ~ ~ lime_wool
execute if score lobby.handler lobby.timer.voteStage matches 862 in lobby:lobby as @e[type=item] if items entity @s container.0 yellow_wool \
        run setblock ~ ~ ~ yellow_wool
execute if score lobby.handler lobby.timer.voteStage matches 862 in lobby:lobby as @e[type=item] if items entity @s container.0 blue_wool \
        run setblock ~ ~ ~ blue_wool
execute if score lobby.handler lobby.timer.voteStage matches 862 in lobby:lobby as @e[type=item] if items entity @s container.0 light_blue_wool \
        run setblock ~ ~ ~ light_blue_wool
execute if score lobby.handler lobby.timer.voteStage matches 862 in lobby:lobby as @e[type=item] if items entity @s container.0 gray_wool \
