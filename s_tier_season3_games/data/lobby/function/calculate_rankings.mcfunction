...
scoreboard players set $stmc.highest stats.points.team.rank -1

# then determine the highest value
scoreboard players operation $stmc.highest stats.points.team.rank > team.RedRaccoons stats.points.team
scoreboard players operation $stmc.highest stats.points.team.rank > team.OrangeOtters stats.points.team
scoreboard players operation $stmc.highest stats.points.team.rank > team.PinkPikas stats.points.team
scoreboard players operation $stmc.highest stats.points.team.rank > team.GreenGoats stats.points.team
scoreboard players operation $stmc.highest stats.points.team.rank > team.CyanCougars stats.points.team
scoreboard players operation $stmc.highest stats.points.team.rank > team.PurplePenguins stats.points.team

# then determine which team has that highest value & give them the highest rank applicable
execute if score $stmc.highest stats.points.team.rank = team.RedRaccoons stats.points.team run scoreboard players set team.RedRaccoons stats.points.team.rank 1
execute if score $stmc.highest stats.points.team.rank = team.OrangeOtters stats.points.team run scoreboard players set team.OrangeOtters stats.points.team.rank 1
execute if score $stmc.highest stats.points.team.rank = team.PinkPikas stats.points.team run scoreboard players set team.PinkPikas stats.points.team.rank 1
execute if score $stmc.highest stats.points.team.rank = team.GreenGoats stats.points.team run scoreboard players set team.GreenGoats stats.points.team.rank 1
execute if score $stmc.highest stats.points.team.rank = team.CyanCougars stats.points.team run scoreboard players set team.CyanCougars stats.points.team.rank 1
execute if score $stmc.highest stats.points.team.rank = team.PurplePenguins stats.points.team run scoreboard players set team.PurplePenguins stats.points.team.rank 1
...
scoreboard players operation $stmc.highest stats.points.team.rank > team.CyanCougars stats.points.team
scoreboard players operation $stmc.highest stats.points.team.rank > team.PurplePenguins stats.points.team
execute if score $stmc.highest stats.points.team.rank = team.RedRaccoons stats.points.team run scoreboard players set team.RedRaccoons stats.points.team.rank 2
execute if score $stmc.highest stats.points.team.rank = team.OrangeOtters stats.points.team run scoreboard players set team.OrangeOtters stats.points.team.rank 2
execute if score $stmc.highest stats.points.team.rank = team.PinkPikas stats.points.team run scoreboard players set team.PinkPikas stats.points.team.rank 2
execute if score $stmc.highest stats.points.team.rank = team.GreenGoats stats.points.team run scoreboard players set team.GreenGoats stats.points.team.rank 2
execute if score $stmc.highest stats.points.team.rank = team.CyanCougars stats.points.team run scoreboard players set team.CyanCougars stats.points.team.rank 2
execute if score $stmc.highest stats.points.team.rank = team.PurplePenguins stats.points.team run scoreboard players set team.PurplePenguins stats.points.team.rank 2
...
scoreboard players operation $stmc.highest stats.points.team.rank > team.CyanCougars stats.points.team
scoreboard players operation $stmc.highest stats.points.team.rank > team.PurplePenguins stats.points.team
execute if score $stmc.highest stats.points.team.rank = team.RedRaccoons stats.points.team run scoreboard players set team.RedRaccoons stats.points.team.rank 3
execute if score $stmc.highest stats.points.team.rank = team.OrangeOtters stats.points.team run scoreboard players set team.OrangeOtters stats.points.team.rank 3
execute if score $stmc.highest stats.points.team.rank = team.PinkPikas stats.points.team run scoreboard players set team.PinkPikas stats.points.team.rank 3
execute if score $stmc.highest stats.points.team.rank = team.GreenGoats stats.points.team run scoreboard players set team.GreenGoats stats.points.team.rank 3
execute if score $stmc.highest stats.points.team.rank = team.CyanCougars stats.points.team run scoreboard players set team.CyanCougars stats.points.team.rank 3
execute if score $stmc.highest stats.points.team.rank = team.PurplePenguins stats.points.team run scoreboard players set team.PurplePenguins stats.points.team.rank 3
...
scoreboard players operation $stmc.highest stats.points.team.rank > team.CyanCougars stats.points.team
scoreboard players operation $stmc.highest stats.points.team.rank > team.PurplePenguins stats.points.team
execute if score $stmc.highest stats.points.team.rank = team.RedRaccoons stats.points.team run scoreboard players set team.RedRaccoons stats.points.team.rank 4
execute if score $stmc.highest stats.points.team.rank = team.OrangeOtters stats.points.team run scoreboard players set team.OrangeOtters stats.points.team.rank 4
execute if score $stmc.highest stats.points.team.rank = team.PinkPikas stats.points.team run scoreboard players set team.PinkPikas stats.points.team.rank 4
execute if score $stmc.highest stats.points.team.rank = team.GreenGoats stats.points.team run scoreboard players set team.GreenGoats stats.points.team.rank 4
execute if score $stmc.highest stats.points.team.rank = team.CyanCougars stats.points.team run scoreboard players set team.CyanCougars stats.points.team.rank 4
execute if score $stmc.highest stats.points.team.rank = team.PurplePenguins stats.points.team run scoreboard players set team.PurplePenguins stats.points.team.rank 4
...
scoreboard players operation $stmc.highest stats.points.team.rank > team.CyanCougars stats.points.team
scoreboard players operation $stmc.highest stats.points.team.rank > team.PurplePenguins stats.points.team
execute if score $stmc.highest stats.points.team.rank = team.RedRaccoons stats.points.team run scoreboard players set team.RedRaccoons stats.points.team.rank 5
execute if score $stmc.highest stats.points.team.rank = team.OrangeOtters stats.points.team run scoreboard players set team.OrangeOtters stats.points.team.rank 5
execute if score $stmc.highest stats.points.team.rank = team.PinkPikas stats.points.team run scoreboard players set team.PinkPikas stats.points.team.rank 5
execute if score $stmc.highest stats.points.team.rank = team.GreenGoats stats.points.team run scoreboard players set team.GreenGoats stats.points.team.rank 5
execute if score $stmc.highest stats.points.team.rank = team.CyanCougars stats.points.team run scoreboard players set team.CyanCougars stats.points.team.rank 5
execute if score $stmc.highest stats.points.team.rank = team.PurplePenguins stats.points.team run scoreboard players set team.PurplePenguins stats.points.team.rank 5
...
scoreboard players operation $stmc.highest stats.points.team.rank > team.CyanCougars stats.points.team
scoreboard players operation $stmc.highest stats.points.team.rank > team.PurplePenguins stats.points.team
execute if score $stmc.highest stats.points.team.rank = team.RedRaccoons stats.points.team run scoreboard players set team.RedRaccoons stats.points.team.rank 6
execute if score $stmc.highest stats.points.team.rank = team.OrangeOtters stats.points.team run scoreboard players set team.OrangeOtters stats.points.team.rank 6
execute if score $stmc.highest stats.points.team.rank = team.PinkPikas stats.points.team run scoreboard players set team.PinkPikas stats.points.team.rank 6
execute if score $stmc.highest stats.points.team.rank = team.GreenGoats stats.points.team run scoreboard players set team.GreenGoats stats.points.team.rank 6
execute if score $stmc.highest stats.points.team.rank = team.CyanCougars stats.points.team run scoreboard players set team.CyanCougars stats.points.team.rank 6
execute if score $stmc.highest stats.points.team.rank = team.PurplePenguins stats.points.team run scoreboard players set team.PurplePenguins stats.points.team.rank 6
execute if score team.RedRaccoons stats.points.team.rank matches 6 run scoreboard players reset team.RedRaccoons stats.points.team.temp
execute if score team.OrangeOtters stats.points.team.rank matches 6 run scoreboard players reset team.OrangeOtters stats.points.team.temp
execute if score team.PinkPikas stats.points.team.rank matches 6 run scoreboard players reset team.PinkPikas stats.points.team.temp
execute if score team.GreenGoats stats.points.team.rank matches 6 run scoreboard players reset team.GreenGoats stats.points.team.temp
execute if score team.CyanCougars stats.points.team.rank matches 6 run scoreboard players reset team.CyanCougars stats.points.team.temp
execute if score team.PurplePenguins stats.points.team.rank matches 6 run scoreboard players reset team.PurplePenguins stats.points.team.temp
