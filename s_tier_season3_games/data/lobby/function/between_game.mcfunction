...
execute if score stmc.handler event.stage matches 2 if score stmc.handler event.timer.bgActive matches 1 run scoreboard players set stmc.handler event.timer.bgMins 2
...
execute if score stmc.handler event.stage matches 2 if score stmc.handler event.timer.bgActive matches 2700 run title @a title {text:"Brawl",color:gold,bold:true}
...
# move to next game
execute if score stmc.handler event.stage matches 2 if score stmc.handler event.timer.bgActive matches 2760.. run scoreboard players set stmc.handler event.stage 3
...
# and reset timers
execute if score stmc.handler event.stage matches 3 if score stmc.handler event.timer.bgActive matches 2760.. run scoreboard players set stmc.handler event.timer.bgActive 0
