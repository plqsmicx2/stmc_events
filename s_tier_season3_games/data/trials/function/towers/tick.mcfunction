...
function trials:towers/sidebar with storage stmc:global

# run automatic pause
execute unless score towers.handler towers.stage matches 3 run function thread:automatic_pause
...
execute in trials:towers if score towers.handler towers.stage matches 0 if score towers.handler towers.timer.delay1 matches 5 run fill -40 100 -40 40 120 40 air replace #concrete_powder
execute in trials:towers if score towers.handler towers.stage matches 0 if score towers.handler towers.timer.delay1 matches 7 run kill @e[type=!player]
...
execute if score towers.handler towers.stage matches 2 if score towers.handler towers.timer.delay2 matches 200.. run function trials:towers/start_game
...
execute if score towers.handler towers.stage matches 4 if score towers.handler towers.timer.delay3 matches 200.. run function trials:towers/reset