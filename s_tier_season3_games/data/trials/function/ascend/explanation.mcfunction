...
execute in trials:ascend if score ascend.handler ascend.timer.explanation matches 1 run tp @a 0 103 -5 0 10
...
# blurb #2
execute in trials:ascend if score ascend.handler ascend.timer.explanation matches 160 run tp @a 6 132 6 135 0
...
# blurb #3
execute in trials:ascend if score ascend.handler ascend.timer.explanation matches 320 run tp @a -1 152.5 8 23 0
...
# blurb #4
execute in trials:ascend if score ascend.handler ascend.timer.explanation matches 480 run tp @a 3 171.5 5 -10 0
...
# blurb #5
execute in trials:ascend if score ascend.handler ascend.timer.explanation matches 640 run tp @a -22 197 -10 -125 25
...
# blurb #6
execute in trials:ascend if score ascend.handler ascend.timer.explanation matches 800 run tp @a 0 78 0 180 0
execute in trials:ascend if score ascend.handler ascend.timer.explanation matches 800 run gamemode adventure @a
execute in trials:ascend if score ascend.handler ascend.timer.explanation matches 800 run gamemode spectator @a[team=SPECTATORS]
