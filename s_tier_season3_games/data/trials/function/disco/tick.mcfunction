...
function trials:disco/sidebar with storage stmc:global
execute if score disco.handler disco.stage matches 3 run function trials:disco/death_handler

# run automatic pause
execute unless score disco.handler disco.stage matches 3 run function thread:automatic_pause
...
execute if score disco.handler disco.timer.delay2 matches 100 run title @a actionbar {"text":"Starting in 5!","color":"dark_aqua"}
execute as @a at @s if score disco.handler disco.timer.delay2 matches 100 run playsound minecraft:block.amethyst_cluster.hit master @s ~ ~ ~ 0.4 1.6
execute if score disco.handler disco.timer.delay2 matches 120 run title @a actionbar {"text":"Starting in 4!","color":"dark_aqua"}
execute as @a at @s if score disco.handler disco.timer.delay2 matches 120 run playsound minecraft:block.amethyst_cluster.hit master @s ~ ~ ~ 0.4 1.7
execute if score disco.handler disco.timer.delay2 matches 140 run title @a actionbar {"text":"Starting in 3!","color":"dark_aqua"}
execute as @a at @s if score disco.handler disco.timer.delay2 matches 140 run playsound minecraft:block.amethyst_cluster.hit master @s ~ ~ ~ 0.5 1.8
execute if score disco.handler disco.timer.delay2 matches 160 run title @a actionbar {"text":"Starting in 2!","color":"dark_aqua"}
execute as @a at @s if score disco.handler disco.timer.delay2 matches 160 run playsound minecraft:block.amethyst_cluster.hit master @s ~ ~ ~ 0.6 1.9
execute if score disco.handler disco.timer.delay2 matches 180 run title @a actionbar {"text":"Starting in 1!","color":"dark_aqua"}
