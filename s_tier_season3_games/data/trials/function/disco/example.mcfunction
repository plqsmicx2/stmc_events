...
execute if score disco.handler disco.timer.example = disco.handler disco.current_round_length_delay in trials:disco run clear @a amethyst_block
execute if score disco.handler disco.timer.example = disco.handler disco.current_round_length_delay in trials:disco run clear @a ochre_froglight
execute if score disco.handler disco.timer.example = disco.handler disco.current_round_length_delay in trials:disco run clear @a pink_wool
execute if score disco.handler disco.timer.example = disco.handler disco.current_round_length_delay in trials:disco run clear @a emerald_block
execute if score disco.handler disco.timer.example = disco.handler disco.current_round_length_delay in trials:disco run clear @a orange_glazed_terracotta
