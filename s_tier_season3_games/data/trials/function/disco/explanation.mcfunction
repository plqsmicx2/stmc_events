...
execute if score disco.handler disco.timer.explanation matches 160 as @e[tag=upper_level] store result entity @s Pos[0] double 1 run random value -25..10
...
execute if score disco.handler disco.timer.explanation matches 160 as @e[tag=upper_level] store result entity @s Pos[2] double 1 run random value -25..10
execute if score disco.handler disco.timer.explanation matches 160 as @e[tag=upper_level] positioned as @s in trials:disco run clone ~ ~ ~ ~14 ~ ~14 -7 116 -7
execute if score disco.handler disco.timer.explanation matches 160 run kill @e[tag=upper_level]

execute in trials:disco if score disco.handler disco.timer.explanation matches 160 run tp @a 0 125 0 0 90
...
# blurb #3
execute in trials:disco if score disco.handler disco.timer.explanation matches 320 run fill -7 116 -7 7 116 7 air replace minecraft:black_concrete
execute in trials:disco if score disco.handler disco.timer.explanation matches 320 run fill -7 116 -7 7 116 7 air replace minecraft:tinted_glass
execute in trials:disco if score disco.handler disco.timer.explanation matches 320 run fill -7 116 -7 7 116 7 air replace minecraft:stripped_dark_oak_wood
execute in trials:disco if score disco.handler disco.timer.explanation matches 320 run fill -7 116 -7 7 116 7 air replace minecraft:snow_block
execute in trials:disco if score disco.handler disco.timer.explanation matches 320 run fill -7 116 -7 7 116 7 air replace minecraft:moss_block
execute in trials:disco if score disco.handler disco.timer.explanation matches 320 run fill -7 116 -7 7 116 7 air replace minecraft:shroomlight
...
# blurb #5
execute in trials:disco if score disco.handler disco.timer.explanation matches 640 run tp @a 0 118 0 0 30
execute in trials:disco if score disco.handler disco.timer.explanation matches 640 run fill -7 116 -7 7 116 7 tinted_glass
...
execute if score disco.handler disco.timer.explanation matches 640 run tellraw @a {text:"The round beings in 10 seconds!","color":"aqua"}
execute if score disco.handler disco.timer.explanation matches 640 run tellraw @a {text:" "}
