...
execute in trials:disco if score disco.handler disco.timer.explanation matches 320 run fill -5 103 -5 5 107 5 air replace minecraft:amethyst_block
execute in trials:disco if score disco.handler disco.timer.explanation matches 320 run fill -5 103 -5 5 107 5 air replace minecraft:ochre_froglight
execute in trials:disco if score disco.handler disco.timer.explanation matches 320 run fill -5 103 -5 5 107 5 air replace minecraft:emerald_block
execute in trials:disco if score disco.handler disco.timer.explanation matches 320 run fill -5 103 -5 5 107 5 air replace minecraft:orange_glazed_terracotta
