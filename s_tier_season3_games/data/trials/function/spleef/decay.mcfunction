...
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2000 run fill -15 100 -15 15 109 15 minecraft:red_wool replace minecraft:snow_block
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2000 run fill -14 100 -14 14 109 14 minecraft:snow_block replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2040 run fill -15 100 -15 15 109 15 minecraft:red_concrete replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2060 run fill -15 100 -15 15 109 15 minecraft:air replace minecraft:red_concrete

execute in trials:spleef if score spleef.handler spleef.timer.game matches 2060 run fill -14 100 -14 14 109 14 minecraft:red_wool replace minecraft:snow_block
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2060 run fill -13 100 -13 13 109 13 minecraft:snow_block replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2100 run fill -14 100 -14 14 109 14 minecraft:red_concrete replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2120 run fill -14 100 -14 14 109 14 minecraft:air replace minecraft:red_concrete

execute in trials:spleef if score spleef.handler spleef.timer.game matches 2120 run fill -13 100 -13 13 109 13 minecraft:red_wool replace minecraft:snow_block
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2120 run fill -12 100 -12 12 109 12 minecraft:snow_block replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2160 run fill -13 100 -13 13 109 13 minecraft:red_concrete replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2180 run fill -13 100 -13 13 109 13 minecraft:air replace minecraft:red_concrete

execute in trials:spleef if score spleef.handler spleef.timer.game matches 2180 run fill -12 100 -12 12 109 12 minecraft:red_wool replace minecraft:snow_block
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2180 run fill -11 100 -11 11 109 11 minecraft:snow_block replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2220 run fill -12 100 -12 12 109 12 minecraft:red_concrete replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2240 run fill -12 100 -12 12 109 12 minecraft:air replace minecraft:red_concrete

execute in trials:spleef if score spleef.handler spleef.timer.game matches 2240 run fill -11 100 -11 11 109 11 minecraft:red_wool replace minecraft:snow_block
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2240 run fill -10 100 -10 10 109 10 minecraft:snow_block replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2280 run fill -11 100 -11 11 109 11 minecraft:red_concrete replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2300 run fill -11 100 -11 11 109 11 minecraft:air replace minecraft:red_concrete

execute in trials:spleef if score spleef.handler spleef.timer.game matches 2300 run fill -10 100 -10 10 109 10 minecraft:red_wool replace minecraft:snow_block
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2300 run fill -9 100 -9 9 109 9 minecraft:snow_block replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2340 run fill -10 100 -10 10 109 10 minecraft:red_concrete replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2360 run fill -10 100 -10 10 109 10 minecraft:air replace minecraft:red_concrete

execute in trials:spleef if score spleef.handler spleef.timer.game matches 2360 run fill -9 100 -9 9 109 9 minecraft:red_wool replace minecraft:snow_block
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2360 run fill -8 100 -8 8 109 8 minecraft:snow_block replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2400 run fill -9 100 -9 9 109 9 minecraft:red_concrete replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2420 run fill -9 100 -9 9 109 9 minecraft:air replace minecraft:red_concrete

execute in trials:spleef if score spleef.handler spleef.timer.game matches 2420 run fill -8 100 -8 8 109 8 minecraft:red_wool replace minecraft:snow_block
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2420 run fill -7 100 -7 7 109 7 minecraft:snow_block replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2460 run fill -8 100 -8 8 109 8 minecraft:red_concrete replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2480 run fill -8 100 -8 8 109 8 minecraft:air replace minecraft:red_concrete

execute in trials:spleef if score spleef.handler spleef.timer.game matches 2480 run fill -7 100 -7 7 109 7 minecraft:red_wool replace minecraft:snow_block
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2480 run fill -6 100 -6 6 109 6 minecraft:snow_block replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2520 run fill -7 100 -7 7 109 7 minecraft:red_concrete replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2540 run fill -7 100 -7 7 109 7 minecraft:air replace minecraft:red_concrete

execute in trials:spleef if score spleef.handler spleef.timer.game matches 2540 run fill -6 100 -6 6 109 6 minecraft:red_wool replace minecraft:snow_block
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2540 run fill -5 100 -5 5 109 5 minecraft:snow_block replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2580 run fill -6 100 -6 6 109 6 minecraft:red_concrete replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2600 run fill -6 100 -6 6 109 6 minecraft:air replace minecraft:red_concrete

execute in trials:spleef if score spleef.handler spleef.timer.game matches 2600 run fill -5 100 -5 5 109 5 minecraft:red_wool replace minecraft:snow_block
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2600 run fill -4 100 -4 4 109 4 minecraft:snow_block replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2640 run fill -5 100 -5 5 109 5 minecraft:red_concrete replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2660 run fill -5 100 -5 5 109 5 minecraft:air replace minecraft:red_concrete

execute in trials:spleef if score spleef.handler spleef.timer.game matches 2660 run fill -4 100 -4 4 109 4 minecraft:red_wool replace minecraft:snow_block
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2660 run fill -3 100 -3 3 109 3 minecraft:snow_block replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2700 run fill -4 100 -4 4 109 4 minecraft:red_concrete replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2720 run fill -4 100 -4 4 109 4 minecraft:air replace minecraft:red_concrete

execute in trials:spleef if score spleef.handler spleef.timer.game matches 2720 run fill -3 100 -3 3 109 3 minecraft:red_wool replace minecraft:snow_block
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2720 run fill -2 100 -2 2 109 2 minecraft:snow_block replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2760 run fill -3 100 -3 3 109 3 minecraft:red_concrete replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2780 run fill -3 100 -3 3 109 3 minecraft:air replace minecraft:red_concrete

execute in trials:spleef if score spleef.handler spleef.timer.game matches 2780 run fill -2 100 -2 2 109 2 minecraft:red_wool replace minecraft:snow_block
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2780 run fill -1 100 -1 1 109 1 minecraft:snow_block replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2820 run fill -2 100 -2 2 109 2 minecraft:red_concrete replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2840 run fill -2 100 -2 2 109 2 minecraft:air replace minecraft:red_concrete

execute in trials:spleef if score spleef.handler spleef.timer.game matches 2840 run fill -1 100 -1 1 109 1 minecraft:red_wool replace minecraft:snow_block
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2840 run fill 0 100 0 0 109 0 minecraft:snow_block replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2880 run fill -1 100 -1 1 109 1 minecraft:red_concrete replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2900 run fill -1 100 -1 1 109 1 minecraft:air replace minecraft:red_concrete

execute in trials:spleef if score spleef.handler spleef.timer.game matches 2900 run fill 0 100 0 0 109 0 minecraft:red_wool replace minecraft:snow_block
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2940 run fill 0 100 0 0 109 0 minecraft:red_concrete replace minecraft:red_wool
execute in trials:spleef if score spleef.handler spleef.timer.game matches 2960 run fill 0 100 0 0 109 0 minecraft:air replace minecraft:red_concrete