...
function trials:replicate/rankings/overall
...
function trials:replicate/rankings/build1

# build #2

# run the helper function to calculate rankings
function trials:replicate/rankings/build2

# build #3

# run the helper function to calculate rankings
function trials:replicate/rankings/build3

# build #4

# run the helper function to calculate rankings
function trials:replicate/rankings/build4

# build #5

# run the helper function to calculate rankings
function trials:replicate/rankings/build5

# build #6

# run the helper function to calculate rankings
function trials:replicate/rankings/build6