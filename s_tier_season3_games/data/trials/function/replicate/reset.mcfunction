...
execute if score replicate.RedRaccoons replicate.points.rank.build1 matches 1 run scoreboard players set replicate.RedRaccoons replicate.timer.build1 4800
execute if score replicate.OrangeOtters replicate.points.rank.build1 matches 1 run scoreboard players set replicate.OrangeOtters replicate.timer.build1 4800
execute if score replicate.PinkPikas replicate.points.rank.build1 matches 1 run scoreboard players set replicate.PinkPikas replicate.timer.build1 4800
execute if score replicate.GreenGoats replicate.points.rank.build1 matches 1 run scoreboard players set replicate.GreenGoats replicate.timer.build1 4800
execute if score replicate.CyanCougars replicate.points.rank.build1 matches 1 run scoreboard players set replicate.CyanCougars replicate.timer.build1 4800
execute if score replicate.PurplePenguins replicate.points.rank.build1 matches 1 run scoreboard players set replicate.PurplePenguins replicate.timer.build1 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build1 matches 2 run scoreboard players set replicate.RedRaccoons replicate.timer.build1 4800
execute if score replicate.OrangeOtters replicate.points.rank.build1 matches 2 run scoreboard players set replicate.OrangeOtters replicate.timer.build1 4800
execute if score replicate.PinkPikas replicate.points.rank.build1 matches 2 run scoreboard players set replicate.PinkPikas replicate.timer.build1 4800
execute if score replicate.GreenGoats replicate.points.rank.build1 matches 2 run scoreboard players set replicate.GreenGoats replicate.timer.build1 4800
execute if score replicate.CyanCougars replicate.points.rank.build1 matches 2 run scoreboard players set replicate.CyanCougars replicate.timer.build1 4800
execute if score replicate.PurplePenguins replicate.points.rank.build1 matches 2 run scoreboard players set replicate.PurplePenguins replicate.timer.build1 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build1 matches 3 run scoreboard players set replicate.RedRaccoons replicate.timer.build1 4800
execute if score replicate.OrangeOtters replicate.points.rank.build1 matches 3 run scoreboard players set replicate.OrangeOtters replicate.timer.build1 4800
execute if score replicate.PinkPikas replicate.points.rank.build1 matches 3 run scoreboard players set replicate.PinkPikas replicate.timer.build1 4800
execute if score replicate.GreenGoats replicate.points.rank.build1 matches 3 run scoreboard players set replicate.GreenGoats replicate.timer.build1 4800
execute if score replicate.CyanCougars replicate.points.rank.build1 matches 3 run scoreboard players set replicate.CyanCougars replicate.timer.build1 4800
execute if score replicate.PurplePenguins replicate.points.rank.build1 matches 3 run scoreboard players set replicate.PurplePenguins replicate.timer.build1 4800
...
execute if score replicate.OrangeOtters replicate.points.rank.build1 matches 4 run scoreboard players set replicate.OrangeOtters replicate.timer.build1 4800
execute if score replicate.PinkPikas replicate.points.rank.build1 matches 4 run scoreboard players set replicate.PinkPikas replicate.timer.build1 4800
execute if score replicate.GreenGoats replicate.points.rank.build1 matches 4 run scoreboard players set replicate.GreenGoats replicate.timer.build1 4800
execute if score replicate.CyanCougars replicate.points.rank.build1 matches 4 run scoreboard players set replicate.CyanCougars replicate.timer.build1 4800
execute if score replicate.PurplePenguins replicate.points.rank.build1 matches 4 run scoreboard players set replicate.PurplePenguins replicate.timer.build1 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build1 matches 5 run scoreboard players set replicate.RedRaccoons replicate.timer.build1 4800
execute if score replicate.OrangeOtters replicate.points.rank.build1 matches 5 run scoreboard players set replicate.OrangeOtters replicate.timer.build1 4800
execute if score replicate.PinkPikas replicate.points.rank.build1 matches 5 run scoreboard players set replicate.PinkPikas replicate.timer.build1 4800
execute if score replicate.GreenGoats replicate.points.rank.build1 matches 5 run scoreboard players set replicate.GreenGoats replicate.timer.build1 4800
execute if score replicate.CyanCougars replicate.points.rank.build1 matches 5 run scoreboard players set replicate.CyanCougars replicate.timer.build1 4800
execute if score replicate.PurplePenguins replicate.points.rank.build1 matches 5 run scoreboard players set replicate.PurplePenguins replicate.timer.build1 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build2 matches 1 run scoreboard players set replicate.RedRaccoons replicate.timer.build2 4800
execute if score replicate.OrangeOtters replicate.points.rank.build2 matches 1 run scoreboard players set replicate.OrangeOtters replicate.timer.build2 4800
execute if score replicate.PinkPikas replicate.points.rank.build2 matches 1 run scoreboard players set replicate.PinkPikas replicate.timer.build2 4800
execute if score replicate.GreenGoats replicate.points.rank.build2 matches 1 run scoreboard players set replicate.GreenGoats replicate.timer.build2 4800
execute if score replicate.CyanCougars replicate.points.rank.build2 matches 1 run scoreboard players set replicate.CyanCougars replicate.timer.build2 4800
execute if score replicate.PurplePenguins replicate.points.rank.build2 matches 1 run scoreboard players set replicate.PurplePenguins replicate.timer.build2 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build2 matches 2 run scoreboard players set replicate.RedRaccoons replicate.timer.build2 4800
execute if score replicate.OrangeOtters replicate.points.rank.build2 matches 2 run scoreboard players set replicate.OrangeOtters replicate.timer.build2 4800
execute if score replicate.PinkPikas replicate.points.rank.build2 matches 2 run scoreboard players set replicate.PinkPikas replicate.timer.build2 4800
execute if score replicate.GreenGoats replicate.points.rank.build2 matches 2 run scoreboard players set replicate.GreenGoats replicate.timer.build2 4800
execute if score replicate.CyanCougars replicate.points.rank.build2 matches 2 run scoreboard players set replicate.CyanCougars replicate.timer.build2 4800
execute if score replicate.PurplePenguins replicate.points.rank.build2 matches 2 run scoreboard players set replicate.PurplePenguins replicate.timer.build2 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build2 matches 3 run scoreboard players set replicate.RedRaccoons replicate.timer.build2 4800
execute if score replicate.OrangeOtters replicate.points.rank.build2 matches 3 run scoreboard players set replicate.OrangeOtters replicate.timer.build2 4800
execute if score replicate.PinkPikas replicate.points.rank.build2 matches 3 run scoreboard players set replicate.PinkPikas replicate.timer.build2 4800
execute if score replicate.GreenGoats replicate.points.rank.build2 matches 3 run scoreboard players set replicate.GreenGoats replicate.timer.build2 4800
execute if score replicate.CyanCougars replicate.points.rank.build2 matches 3 run scoreboard players set replicate.CyanCougars replicate.timer.build2 4800
execute if score replicate.PurplePenguins replicate.points.rank.build2 matches 3 run scoreboard players set replicate.PurplePenguins replicate.timer.build2 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build2 matches 4 run scoreboard players set replicate.RedRaccoons replicate.timer.build2 4800
execute if score replicate.OrangeOtters replicate.points.rank.build2 matches 4 run scoreboard players set replicate.OrangeOtters replicate.timer.build2 4800
execute if score replicate.PinkPikas replicate.points.rank.build2 matches 4 run scoreboard players set replicate.PinkPikas replicate.timer.build2 4800
execute if score replicate.GreenGoats replicate.points.rank.build2 matches 4 run scoreboard players set replicate.GreenGoats replicate.timer.build2 4800
execute if score replicate.CyanCougars replicate.points.rank.build2 matches 4 run scoreboard players set replicate.CyanCougars replicate.timer.build2 4800
execute if score replicate.PurplePenguins replicate.points.rank.build2 matches 4 run scoreboard players set replicate.PurplePenguins replicate.timer.build2 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build2 matches 5 run scoreboard players set replicate.RedRaccoons replicate.timer.build2 4800
execute if score replicate.OrangeOtters replicate.points.rank.build2 matches 5 run scoreboard players set replicate.OrangeOtters replicate.timer.build2 4800
execute if score replicate.PinkPikas replicate.points.rank.build2 matches 5 run scoreboard players set replicate.PinkPikas replicate.timer.build2 4800
execute if score replicate.GreenGoats replicate.points.rank.build2 matches 5 run scoreboard players set replicate.GreenGoats replicate.timer.build2 4800
execute if score replicate.CyanCougars replicate.points.rank.build2 matches 5 run scoreboard players set replicate.CyanCougars replicate.timer.build2 4800
execute if score replicate.PurplePenguins replicate.points.rank.build2 matches 5 run scoreboard players set replicate.PurplePenguins replicate.timer.build2 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build3 matches 1 run scoreboard players set replicate.RedRaccoons replicate.timer.build3 4800
execute if score replicate.OrangeOtters replicate.points.rank.build3 matches 1 run scoreboard players set replicate.OrangeOtters replicate.timer.build3 4800
execute if score replicate.PinkPikas replicate.points.rank.build3 matches 1 run scoreboard players set replicate.PinkPikas replicate.timer.build3 4800
execute if score replicate.GreenGoats replicate.points.rank.build3 matches 1 run scoreboard players set replicate.GreenGoats replicate.timer.build3 4800
execute if score replicate.CyanCougars replicate.points.rank.build3 matches 1 run scoreboard players set replicate.CyanCougars replicate.timer.build3 4800
execute if score replicate.PurplePenguins replicate.points.rank.build3 matches 1 run scoreboard players set replicate.PurplePenguins replicate.timer.build3 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build3 matches 2 run scoreboard players set replicate.RedRaccoons replicate.timer.build3 4800
execute if score replicate.OrangeOtters replicate.points.rank.build3 matches 2 run scoreboard players set replicate.OrangeOtters replicate.timer.build3 4800
execute if score replicate.PinkPikas replicate.points.rank.build3 matches 2 run scoreboard players set replicate.PinkPikas replicate.timer.build3 4800
execute if score replicate.GreenGoats replicate.points.rank.build3 matches 2 run scoreboard players set replicate.GreenGoats replicate.timer.build3 4800
execute if score replicate.CyanCougars replicate.points.rank.build3 matches 2 run scoreboard players set replicate.CyanCougars replicate.timer.build3 4800
execute if score replicate.PurplePenguins replicate.points.rank.build3 matches 2 run scoreboard players set replicate.PurplePenguins replicate.timer.build3 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build3 matches 3 run scoreboard players set replicate.RedRaccoons replicate.timer.build3 4800
execute if score replicate.OrangeOtters replicate.points.rank.build3 matches 3 run scoreboard players set replicate.OrangeOtters replicate.timer.build3 4800
execute if score replicate.PinkPikas replicate.points.rank.build3 matches 3 run scoreboard players set replicate.PinkPikas replicate.timer.build3 4800
execute if score replicate.GreenGoats replicate.points.rank.build3 matches 3 run scoreboard players set replicate.GreenGoats replicate.timer.build3 4800
execute if score replicate.CyanCougars replicate.points.rank.build3 matches 3 run scoreboard players set replicate.CyanCougars replicate.timer.build3 4800
execute if score replicate.PurplePenguins replicate.points.rank.build3 matches 3 run scoreboard players set replicate.PurplePenguins replicate.timer.build3 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build3 matches 4 run scoreboard players set replicate.RedRaccoons replicate.timer.build3 4800
execute if score replicate.OrangeOtters replicate.points.rank.build3 matches 4 run scoreboard players set replicate.OrangeOtters replicate.timer.build3 4800
execute if score replicate.PinkPikas replicate.points.rank.build3 matches 4 run scoreboard players set replicate.PinkPikas replicate.timer.build3 4800
execute if score replicate.GreenGoats replicate.points.rank.build3 matches 4 run scoreboard players set replicate.GreenGoats replicate.timer.build3 4800
execute if score replicate.CyanCougars replicate.points.rank.build3 matches 4 run scoreboard players set replicate.CyanCougars replicate.timer.build3 4800
execute if score replicate.PurplePenguins replicate.points.rank.build3 matches 4 run scoreboard players set replicate.PurplePenguins replicate.timer.build3 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build3 matches 5 run scoreboard players set replicate.RedRaccoons replicate.timer.build3 4800
execute if score replicate.OrangeOtters replicate.points.rank.build3 matches 5 run scoreboard players set replicate.OrangeOtters replicate.timer.build3 4800
execute if score replicate.PinkPikas replicate.points.rank.build3 matches 5 run scoreboard players set replicate.PinkPikas replicate.timer.build3 4800
execute if score replicate.GreenGoats replicate.points.rank.build3 matches 5 run scoreboard players set replicate.GreenGoats replicate.timer.build3 4800
execute if score replicate.CyanCougars replicate.points.rank.build3 matches 5 run scoreboard players set replicate.CyanCougars replicate.timer.build3 4800
execute if score replicate.PurplePenguins replicate.points.rank.build3 matches 5 run scoreboard players set replicate.PurplePenguins replicate.timer.build3 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build4 matches 1 run scoreboard players set replicate.RedRaccoons replicate.timer.build4 4800
execute if score replicate.OrangeOtters replicate.points.rank.build4 matches 1 run scoreboard players set replicate.OrangeOtters replicate.timer.build4 4800
execute if score replicate.PinkPikas replicate.points.rank.build4 matches 1 run scoreboard players set replicate.PinkPikas replicate.timer.build4 4800
execute if score replicate.GreenGoats replicate.points.rank.build4 matches 1 run scoreboard players set replicate.GreenGoats replicate.timer.build4 4800
execute if score replicate.CyanCougars replicate.points.rank.build4 matches 1 run scoreboard players set replicate.CyanCougars replicate.timer.build4 4800
execute if score replicate.PurplePenguins replicate.points.rank.build4 matches 1 run scoreboard players set replicate.PurplePenguins replicate.timer.build4 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build4 matches 2 run scoreboard players set replicate.RedRaccoons replicate.timer.build4 4800
execute if score replicate.OrangeOtters replicate.points.rank.build4 matches 2 run scoreboard players set replicate.OrangeOtters replicate.timer.build4 4800
execute if score replicate.PinkPikas replicate.points.rank.build4 matches 2 run scoreboard players set replicate.PinkPikas replicate.timer.build4 4800
execute if score replicate.GreenGoats replicate.points.rank.build4 matches 2 run scoreboard players set replicate.GreenGoats replicate.timer.build4 4800
execute if score replicate.CyanCougars replicate.points.rank.build4 matches 2 run scoreboard players set replicate.CyanCougars replicate.timer.build4 4800
execute if score replicate.PurplePenguins replicate.points.rank.build4 matches 2 run scoreboard players set replicate.PurplePenguins replicate.timer.build4 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build4 matches 3 run scoreboard players set replicate.RedRaccoons replicate.timer.build4 4800
execute if score replicate.OrangeOtters replicate.points.rank.build4 matches 3 run scoreboard players set replicate.OrangeOtters replicate.timer.build4 4800
execute if score replicate.PinkPikas replicate.points.rank.build4 matches 3 run scoreboard players set replicate.PinkPikas replicate.timer.build4 4800
execute if score replicate.GreenGoats replicate.points.rank.build4 matches 3 run scoreboard players set replicate.GreenGoats replicate.timer.build4 4800
execute if score replicate.CyanCougars replicate.points.rank.build4 matches 3 run scoreboard players set replicate.CyanCougars replicate.timer.build4 4800
execute if score replicate.PurplePenguins replicate.points.rank.build4 matches 3 run scoreboard players set replicate.PurplePenguins replicate.timer.build4 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build4 matches 4 run scoreboard players set replicate.RedRaccoons replicate.timer.build4 4800
execute if score replicate.OrangeOtters replicate.points.rank.build4 matches 4 run scoreboard players set replicate.OrangeOtters replicate.timer.build4 4800
execute if score replicate.PinkPikas replicate.points.rank.build4 matches 4 run scoreboard players set replicate.PinkPikas replicate.timer.build4 4800
execute if score replicate.GreenGoats replicate.points.rank.build4 matches 4 run scoreboard players set replicate.GreenGoats replicate.timer.build4 4800
execute if score replicate.CyanCougars replicate.points.rank.build4 matches 4 run scoreboard players set replicate.CyanCougars replicate.timer.build4 4800
execute if score replicate.PurplePenguins replicate.points.rank.build4 matches 4 run scoreboard players set replicate.PurplePenguins replicate.timer.build4 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build4 matches 5 run scoreboard players set replicate.RedRaccoons replicate.timer.build4 4800
execute if score replicate.OrangeOtters replicate.points.rank.build4 matches 5 run scoreboard players set replicate.OrangeOtters replicate.timer.build4 4800
execute if score replicate.PinkPikas replicate.points.rank.build4 matches 5 run scoreboard players set replicate.PinkPikas replicate.timer.build4 4800
execute if score replicate.GreenGoats replicate.points.rank.build4 matches 5 run scoreboard players set replicate.GreenGoats replicate.timer.build4 4800
execute if score replicate.CyanCougars replicate.points.rank.build4 matches 5 run scoreboard players set replicate.CyanCougars replicate.timer.build4 4800
execute if score replicate.PurplePenguins replicate.points.rank.build4 matches 5 run scoreboard players set replicate.PurplePenguins replicate.timer.build4 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build5 matches 1 run scoreboard players set replicate.RedRaccoons replicate.timer.build5 4800
execute if score replicate.OrangeOtters replicate.points.rank.build5 matches 1 run scoreboard players set replicate.OrangeOtters replicate.timer.build5 4800
execute if score replicate.PinkPikas replicate.points.rank.build5 matches 1 run scoreboard players set replicate.PinkPikas replicate.timer.build5 4800
execute if score replicate.GreenGoats replicate.points.rank.build5 matches 1 run scoreboard players set replicate.GreenGoats replicate.timer.build5 4800
execute if score replicate.CyanCougars replicate.points.rank.build5 matches 1 run scoreboard players set replicate.CyanCougars replicate.timer.build5 4800
execute if score replicate.PurplePenguins replicate.points.rank.build5 matches 1 run scoreboard players set replicate.PurplePenguins replicate.timer.build5 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build5 matches 2 run scoreboard players set replicate.RedRaccoons replicate.timer.build5 4800
execute if score replicate.OrangeOtters replicate.points.rank.build5 matches 2 run scoreboard players set replicate.OrangeOtters replicate.timer.build5 4800
execute if score replicate.PinkPikas replicate.points.rank.build5 matches 2 run scoreboard players set replicate.PinkPikas replicate.timer.build5 4800
execute if score replicate.GreenGoats replicate.points.rank.build5 matches 2 run scoreboard players set replicate.GreenGoats replicate.timer.build5 4800
execute if score replicate.CyanCougars replicate.points.rank.build5 matches 2 run scoreboard players set replicate.CyanCougars replicate.timer.build5 4800
execute if score replicate.PurplePenguins replicate.points.rank.build5 matches 2 run scoreboard players set replicate.PurplePenguins replicate.timer.build5 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build5 matches 3 run scoreboard players set replicate.RedRaccoons replicate.timer.build5 4800
execute if score replicate.OrangeOtters replicate.points.rank.build5 matches 3 run scoreboard players set replicate.OrangeOtters replicate.timer.build5 4800
execute if score replicate.PinkPikas replicate.points.rank.build5 matches 3 run scoreboard players set replicate.PinkPikas replicate.timer.build5 4800
execute if score replicate.GreenGoats replicate.points.rank.build5 matches 3 run scoreboard players set replicate.GreenGoats replicate.timer.build5 4800
execute if score replicate.CyanCougars replicate.points.rank.build5 matches 3 run scoreboard players set replicate.CyanCougars replicate.timer.build5 4800
execute if score replicate.PurplePenguins replicate.points.rank.build5 matches 3 run scoreboard players set replicate.PurplePenguins replicate.timer.build5 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build5 matches 4 run scoreboard players set replicate.RedRaccoons replicate.timer.build5 4800
execute if score replicate.OrangeOtters replicate.points.rank.build5 matches 4 run scoreboard players set replicate.OrangeOtters replicate.timer.build5 4800
execute if score replicate.PinkPikas replicate.points.rank.build5 matches 4 run scoreboard players set replicate.PinkPikas replicate.timer.build5 4800
execute if score replicate.GreenGoats replicate.points.rank.build5 matches 4 run scoreboard players set replicate.GreenGoats replicate.timer.build5 4800
execute if score replicate.CyanCougars replicate.points.rank.build5 matches 4 run scoreboard players set replicate.CyanCougars replicate.timer.build5 4800
execute if score replicate.PurplePenguins replicate.points.rank.build5 matches 4 run scoreboard players set replicate.PurplePenguins replicate.timer.build5 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build5 matches 5 run scoreboard players set replicate.RedRaccoons replicate.timer.build5 4800
execute if score replicate.OrangeOtters replicate.points.rank.build5 matches 5 run scoreboard players set replicate.OrangeOtters replicate.timer.build5 4800
execute if score replicate.PinkPikas replicate.points.rank.build5 matches 5 run scoreboard players set replicate.PinkPikas replicate.timer.build5 4800
execute if score replicate.GreenGoats replicate.points.rank.build5 matches 5 run scoreboard players set replicate.GreenGoats replicate.timer.build5 4800
execute if score replicate.CyanCougars replicate.points.rank.build5 matches 5 run scoreboard players set replicate.CyanCougars replicate.timer.build5 4800
execute if score replicate.PurplePenguins replicate.points.rank.build5 matches 5 run scoreboard players set replicate.PurplePenguins replicate.timer.build5 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build6 matches 1 run scoreboard players set replicate.RedRaccoons replicate.timer.build6 4800
execute if score replicate.OrangeOtters replicate.points.rank.build6 matches 1 run scoreboard players set replicate.OrangeOtters replicate.timer.build6 4800
execute if score replicate.PinkPikas replicate.points.rank.build6 matches 1 run scoreboard players set replicate.PinkPikas replicate.timer.build6 4800
execute if score replicate.GreenGoats replicate.points.rank.build6 matches 1 run scoreboard players set replicate.GreenGoats replicate.timer.build6 4800
execute if score replicate.CyanCougars replicate.points.rank.build6 matches 1 run scoreboard players set replicate.CyanCougars replicate.timer.build6 4800
execute if score replicate.PurplePenguins replicate.points.rank.build6 matches 1 run scoreboard players set replicate.PurplePenguins replicate.timer.build6 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build6 matches 2 run scoreboard players set replicate.RedRaccoons replicate.timer.build6 4800
execute if score replicate.OrangeOtters replicate.points.rank.build6 matches 2 run scoreboard players set replicate.OrangeOtters replicate.timer.build6 4800
execute if score replicate.PinkPikas replicate.points.rank.build6 matches 2 run scoreboard players set replicate.PinkPikas replicate.timer.build6 4800
execute if score replicate.GreenGoats replicate.points.rank.build6 matches 2 run scoreboard players set replicate.GreenGoats replicate.timer.build6 4800
execute if score replicate.CyanCougars replicate.points.rank.build6 matches 2 run scoreboard players set replicate.CyanCougars replicate.timer.build6 4800
execute if score replicate.PurplePenguins replicate.points.rank.build6 matches 2 run scoreboard players set replicate.PurplePenguins replicate.timer.build6 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build6 matches 3 run scoreboard players set replicate.RedRaccoons replicate.timer.build6 4800
execute if score replicate.OrangeOtters replicate.points.rank.build6 matches 3 run scoreboard players set replicate.OrangeOtters replicate.timer.build6 4800
execute if score replicate.PinkPikas replicate.points.rank.build6 matches 3 run scoreboard players set replicate.PinkPikas replicate.timer.build6 4800
execute if score replicate.GreenGoats replicate.points.rank.build6 matches 3 run scoreboard players set replicate.GreenGoats replicate.timer.build6 4800
execute if score replicate.CyanCougars replicate.points.rank.build6 matches 3 run scoreboard players set replicate.CyanCougars replicate.timer.build6 4800
execute if score replicate.PurplePenguins replicate.points.rank.build6 matches 3 run scoreboard players set replicate.PurplePenguins replicate.timer.build6 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build6 matches 4 run scoreboard players set replicate.RedRaccoons replicate.timer.build6 4800
execute if score replicate.OrangeOtters replicate.points.rank.build6 matches 4 run scoreboard players set replicate.OrangeOtters replicate.timer.build6 4800
execute if score replicate.PinkPikas replicate.points.rank.build6 matches 4 run scoreboard players set replicate.PinkPikas replicate.timer.build6 4800
execute if score replicate.GreenGoats replicate.points.rank.build6 matches 4 run scoreboard players set replicate.GreenGoats replicate.timer.build6 4800
execute if score replicate.CyanCougars replicate.points.rank.build6 matches 4 run scoreboard players set replicate.CyanCougars replicate.timer.build6 4800
execute if score replicate.PurplePenguins replicate.points.rank.build6 matches 4 run scoreboard players set replicate.PurplePenguins replicate.timer.build6 4800
...
execute if score replicate.RedRaccoons replicate.points.rank.build6 matches 5 run scoreboard players set replicate.RedRaccoons replicate.timer.build6 4800
execute if score replicate.OrangeOtters replicate.points.rank.build6 matches 5 run scoreboard players set replicate.OrangeOtters replicate.timer.build6 4800
execute if score replicate.PinkPikas replicate.points.rank.build6 matches 5 run scoreboard players set replicate.PinkPikas replicate.timer.build6 4800
execute if score replicate.GreenGoats replicate.points.rank.build6 matches 5 run scoreboard players set replicate.GreenGoats replicate.timer.build6 4800
execute if score replicate.CyanCougars replicate.points.rank.build6 matches 5 run scoreboard players set replicate.CyanCougars replicate.timer.build6 4800
execute if score replicate.PurplePenguins replicate.points.rank.build6 matches 5 run scoreboard players set replicate.PurplePenguins replicate.timer.build6 4800
