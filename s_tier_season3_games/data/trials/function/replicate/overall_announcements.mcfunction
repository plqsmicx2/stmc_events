...
execute if score replicate.YellowYaks replicate.points.rank.overall matches 1 run tellraw @a ["",{"text": "#1: ", "color": "aqua"}, {"text": " Yellow Yaks", "color": "yellow"}]
...
execute if score replicate.BlueBears replicate.points.rank.overall matches 1 run tellraw @a ["",{"text": "#1: ", "color": "aqua"}, {"text": " Blue Bears", "color": "blue"}]
...
execute if score replicate.YellowYaks replicate.points.rank.overall matches 2 run tellraw @a ["",{"text": "#2: ", "color": "aqua"}, {"text": " Yellow Yaks", "color": "yellow"}]
...
execute if score replicate.BlueBears replicate.points.rank.overall matches 2 run tellraw @a ["",{"text": "#2: ", "color": "aqua"}, {"text": " Blue Bears", "color": "blue"}]
...
execute if score replicate.YellowYaks replicate.points.rank.overall matches 3 run tellraw @a ["",{"text": "#3: ", "color": "aqua"}, {"text": " Yellow Yaks", "color": "yellow"}]
...
execute if score replicate.BlueBears replicate.points.rank.overall matches 3 run tellraw @a ["",{"text": "#3: ", "color": "aqua"}, {"text": " Blue Bears", "color": "blue"}]
...
execute if score replicate.YellowYaks replicate.points.rank.overall matches 4 run tellraw @a ["",{"text": "#4: ", "color": "aqua"}, {"text": " Yellow Yaks", "color": "yellow"}]
...
execute if score replicate.BlueBears replicate.points.rank.overall matches 4 run tellraw @a ["",{"text": "#4: ", "color": "aqua"}, {"text": " Blue Bears", "color": "blue"}]
...
execute if score replicate.YellowYaks replicate.points.rank.overall matches 5 run tellraw @a ["",{"text": "#5: ", "color": "aqua"}, {"text": " Yellow Yaks", "color": "yellow"}]
...
execute if score replicate.BlueBears replicate.points.rank.overall matches 5 run tellraw @a ["",{"text": "#5: ", "color": "aqua"}, {"text": " Blue Bears", "color": "blue"}]
...
execute if score replicate.YellowYaks replicate.points.rank.overall matches 6 run tellraw @a ["",{"text": "#6: ", "color": "aqua"}, {"text": " Yellow Yaks", "color": "yellow"}]
...
execute if score replicate.BlueBears replicate.points.rank.overall matches 6 run tellraw @a ["",{"text": "#6: ", "color": "aqua"}, {"text": " Blue Bears", "color": "blue"}]

# 7th place
execute if score replicate.RedRaccoons replicate.points.rank.overall matches 7 run tellraw @a ["",{"text": "#7: ", "color": "aqua"}, {"text": " Red Raccoons", "color": "dark_red"}]
execute if score replicate.OrangeOtters replicate.points.rank.overall matches 7 run tellraw @a ["",{"text": "#7: ", "color": "aqua"}, {"text": " Orange Otters", "color": "gold"}]
execute if score replicate.PinkPikas replicate.points.rank.overall matches 7 run tellraw @a ["",{"text": "#7: ", "color": "aqua"}, {"text": " Pink Pikas", "color": "light_purple"}]
execute if score replicate.YellowYaks replicate.points.rank.overall matches 7 run tellraw @a ["",{"text": "#7: ", "color": "aqua"}, {"text": " Yellow Yaks", "color": "yellow"}]
execute if score replicate.GreenGoats replicate.points.rank.overall matches 7 run tellraw @a ["",{"text": "#7: ", "color": "aqua"}, {"text": " Green Goats", "color": "dark_green"}]
execute if score replicate.CyanCougars replicate.points.rank.overall matches 7 run tellraw @a ["",{"text": "#7: ", "color": "aqua"}, {"text": " Cyan Cougars", "color": "dark_aqua"}]
execute if score replicate.PurplePenguins replicate.points.rank.overall matches 7 run tellraw @a ["",{"text": "#7: ", "color": "aqua"}, {"text": " Purple Penguins", "color": "dark_purple"}]
execute if score replicate.BlueBears replicate.points.rank.overall matches 7 run tellraw @a ["",{"text": "#7: ", "color": "aqua"}, {"text": " Blue Bears", "color": "blue"}]

# 8th place
execute if score replicate.RedRaccoons replicate.points.rank.overall matches 8 run tellraw @a ["",{"text": "#8: ", "color": "aqua"}, {"text": " Red Raccoons", "color": "dark_red"}]
execute if score replicate.OrangeOtters replicate.points.rank.overall matches 8 run tellraw @a ["",{"text": "#8: ", "color": "aqua"}, {"text": " Orange Otters", "color": "gold"}]
execute if score replicate.PinkPikas replicate.points.rank.overall matches 8 run tellraw @a ["",{"text": "#8: ", "color": "aqua"}, {"text": " Pink Pikas", "color": "light_purple"}]
execute if score replicate.YellowYaks replicate.points.rank.overall matches 8 run tellraw @a ["",{"text": "#8: ", "color": "aqua"}, {"text": " Yellow Yaks", "color": "yellow"}]
execute if score replicate.GreenGoats replicate.points.rank.overall matches 8 run tellraw @a ["",{"text": "#8: ", "color": "aqua"}, {"text": " Green Goats", "color": "dark_green"}]
execute if score replicate.CyanCougars replicate.points.rank.overall matches 8 run tellraw @a ["",{"text": "#8: ", "color": "aqua"}, {"text": " Cyan Cougars", "color": "dark_aqua"}]
execute if score replicate.PurplePenguins replicate.points.rank.overall matches 8 run tellraw @a ["",{"text": "#8: ", "color": "aqua"}, {"text": " Purple Penguins", "color": "dark_purple"}]
execute if score replicate.BlueBears replicate.points.rank.overall matches 8 run tellraw @a ["",{"text": "#8: ", "color": "aqua"}, {"text": " Blue Bears", "color": "blue"}]