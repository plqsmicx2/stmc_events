...
execute if score replicate.OrangeOtters replicate.timer.build1 matches 4.. if score replicate.OrangeOtters replicate.stage matches 0 run item replace entity @a[team=ORANGE_OTTERS] hotbar.3 with snow_block 64
execute if score replicate.OrangeOtters replicate.timer.build1 matches 4.. if score replicate.OrangeOtters replicate.stage matches 0 run item replace entity @a[team=ORANGE_OTTERS] hotbar.4 with green_concrete 64
execute if score replicate.OrangeOtters replicate.timer.build1 matches 4.. if score replicate.OrangeOtters replicate.stage matches 0 run item replace entity @a[team=ORANGE_OTTERS] hotbar.5 with brown_concrete 64
execute if score replicate.OrangeOtters replicate.timer.build1 matches 4.. if score replicate.OrangeOtters replicate.stage matches 0 run item replace entity @a[team=ORANGE_OTTERS] hotbar.6 with packed_mud 64
execute if score replicate.OrangeOtters replicate.timer.build1 matches 4.. if score replicate.OrangeOtters replicate.stage matches 0 run item replace entity @a[team=ORANGE_OTTERS] hotbar.7 with podzol 64
