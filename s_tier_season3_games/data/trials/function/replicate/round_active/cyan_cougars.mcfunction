...
# BUILDS FINDABLE:
# 0- build 1
# --> clone 5 101 10 9 101 14 -40 104 -24
# ----> clone 11 102 10 11 106 14 -33 106 -24
# 1- build 2
# --> clone -9 102 2 -5 102 6 -40 104 -24
# ----> clone -11 102 2 -11 106 6 -33 106 -24
# 2- build 3
# --> clone -9 102 -6 -5 102 -2 -40 104 -24
# ----> clone -11 102 -6 -11 106 -2 -33 106 -24
# 3- build 4
# --> clone 5 101 -14 9 101 -10 -40 104 -24
# ----> clone 11 102 -14 11 106 -10 -33 106 -24
# 4- build 5
# --> clone 5 101 -6 9 101 -2 -40 104 -24
# ----> clone 11 102 -6 11 106 -2 -33 106 -24
# 5- build 6
# --> clone 5 101 2 9 101 6 -40 104 -24
...
# clone the build
execute in trials:replicate if score replicate.CyanCougars replicate.timer.build1 matches 3 run clone 5 101 10 9 101 14 -40 104 -24
...
# clone the build
execute in trials:replicate if score replicate.CyanCougars replicate.timer.build2 matches 3 run clone -9 102 2 -5 102 6 -40 104 -24
...
# give players necessary blocks
execute if score replicate.CyanCougars replicate.timer.build2 matches 4.. if score replicate.CyanCougars replicate.stage matches 1 run item replace entity @a[team=CYAN_COUGARS] hotbar.2 with light_blue_wool 64
execute if score replicate.CyanCougars replicate.timer.build2 matches 4.. if score replicate.CyanCougars replicate.stage matches 1 run item replace entity @a[team=CYAN_COUGARS] hotbar.3 with packed_ice 64
execute if score replicate.CyanCougars replicate.timer.build2 matches 4.. if score replicate.CyanCougars replicate.stage matches 1 run item replace entity @a[team=CYAN_COUGARS] hotbar.4 with snow_block 64
execute if score replicate.CyanCougars replicate.timer.build2 matches 4.. if score replicate.CyanCougars replicate.stage matches 1 run item replace entity @a[team=CYAN_COUGARS] hotbar.5 with redstone_block 64
execute if score replicate.CyanCougars replicate.timer.build2 matches 4.. if score replicate.CyanCougars replicate.stage matches 1 run item replace entity @a[team=CYAN_COUGARS] hotbar.6 with coarse_dirt 64
execute if score replicate.CyanCougars replicate.timer.build2 matches 4.. if score replicate.CyanCougars replicate.stage matches 1 run item replace entity @a[team=CYAN_COUGARS] hotbar.7 with stone_bricks 64
execute if score replicate.CyanCougars replicate.timer.build2 matches 4.. if score replicate.CyanCougars replicate.stage matches 1 run item replace entity @a[team=CYAN_COUGARS] hotbar.8 with iron_block 64
...
# clone the build
execute in trials:replicate if score replicate.CyanCougars replicate.timer.build3 matches 3 run clone -9 102 -6 -5 102 -2 -40 104 -24
...
# clone the build
execute in trials:replicate if score replicate.CyanCougars replicate.timer.build4 matches 3 run clone 5 101 -14 9 101 -10 -40 104 -24
...
# give players necessary blocks
execute if score replicate.CyanCougars replicate.timer.build4 matches 4.. if score replicate.CyanCougars replicate.stage matches 3 run item replace entity @a[team=CYAN_COUGARS] hotbar.5 with white_wool 64
execute if score replicate.CyanCougars replicate.timer.build4 matches 4.. if score replicate.CyanCougars replicate.stage matches 3 run item replace entity @a[team=CYAN_COUGARS] hotbar.6 with calcite 64
execute if score replicate.CyanCougars replicate.timer.build4 matches 4.. if score replicate.CyanCougars replicate.stage matches 3 run item replace entity @a[team=CYAN_COUGARS] hotbar.7 with white_terracotta 64
execute if score replicate.CyanCougars replicate.timer.build4 matches 4.. if score replicate.CyanCougars replicate.stage matches 3 run item replace entity @a[team=CYAN_COUGARS] hotbar.8 with black_concrete 64
...
# clone the build
execute in trials:replicate if score replicate.CyanCougars replicate.timer.build5 matches 3 run clone 5 101 -6 9 101 -2 -40 104 -24
...
# clone the build
execute in trials:replicate if score replicate.CyanCougars replicate.timer.build6 matches 3 run clone 5 101 2 9 101 6 -40 104 -24
