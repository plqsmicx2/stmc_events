...
execute if score replicate.GreenGoats replicate.timer.build6 matches 4.. if score replicate.GreenGoats replicate.stage matches 5 run item replace entity @a[team=GREEN_GOATS] hotbar.8 with blue_concrete 64
