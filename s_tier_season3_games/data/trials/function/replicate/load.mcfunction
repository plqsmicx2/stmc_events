...
scoreboard players set replicate.handler replicate.points.overall.rank2 28
scoreboard players set replicate.handler replicate.points.overall.rank3 24
scoreboard players set replicate.handler replicate.points.overall.rank4 16
scoreboard players set replicate.handler replicate.points.overall.rank5 12
scoreboard players set replicate.handler replicate.points.overall.rank6 8
...
scoreboard players set replicate.handler replicate.points.build.rank1 6
scoreboard players set replicate.handler replicate.points.build.rank2 5
scoreboard players set replicate.handler replicate.points.build.rank3 4
scoreboard players set replicate.handler replicate.points.build.rank4 3
scoreboard players set replicate.handler replicate.points.build.rank5 2
scoreboard players set replicate.handler replicate.points.build.rank6 1
