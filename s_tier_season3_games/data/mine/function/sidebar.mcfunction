...
scoreboard objectives add mine.sidebar dummy
$scoreboard objectives modify mine.sidebar displayname {"text": "$(eventName)", "color": "green", "bold": true}
...
$execute if score mine.RedRaccoons mine.points.team.rank matches 1..3 run scoreboard players display name mine.RedRaccoons mine.sidebar {"text": "  $(redName)", "color": "red"}
...
$execute if score mine.OrangeOtters mine.points.team.rank matches 1..3 run scoreboard players display name mine.OrangeOtters mine.sidebar {"text": "  $(orangeName)", "color": "gold"}
...
$execute if score mine.PinkPikas mine.points.team.rank matches 1..3 run scoreboard players display name mine.PinkPikas mine.sidebar {"text": "  $(pinkName)", "color": "light_purple"}
...
$execute if score mine.YellowYaks mine.points.team.rank matches 1..3 run scoreboard players display name mine.YellowYaks mine.sidebar {"text": "  $(yellowName)", "color": "yellow"}
...
$execute if score mine.GreenGoats mine.points.team.rank matches 1..3 run scoreboard players display name mine.GreenGoats mine.sidebar {"text": "  $(greenName)", "color": "dark_green"}
...
$execute if score mine.CyanCougars mine.points.team.rank matches 1..3 run scoreboard players display name mine.CyanCougars mine.sidebar {"text": "  $(cyanName)", "color": "dark_aqua"}
...
$execute if score mine.PurplePenguins mine.points.team.rank matches 1..3 run scoreboard players display name mine.PurplePenguins mine.sidebar {"text": "  $(purpleName)", "color": "dark_purple"}
...
$execute if score mine.BlueBears mine.points.team.rank matches 1..3 run scoreboard players display name mine.BlueBears mine.sidebar {"text": "  $(blueName)", "color": "blue"}
