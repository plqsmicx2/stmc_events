...
scoreboard objectives add mine.sidebar dummy {"text": "  STMC Open  ", "color": "green", "bold": true}
...
execute if score mine.PinkPikas mine.points.team.rank matches 1..3 run scoreboard players operation mine.YellowYaks mine.sidebar = mine.YellowYaks mine.points.team
execute if score mine.PinkPikas mine.points.team.rank matches 1..3 run scoreboard players display name mine.YellowYaks mine.sidebar {"text": "  Yellow Yaks", "color": "yellow"}
...
execute if score mine.PinkPikas mine.points.team.rank matches 1..3 run scoreboard players operation mine.BlueBears mine.sidebar = mine.BlueBears mine.points.team
execute if score mine.PinkPikas mine.points.team.rank matches 1..3 run scoreboard players display name mine.BlueBears mine.sidebar {"text": "  Blue Bears", "color": "blue"}
