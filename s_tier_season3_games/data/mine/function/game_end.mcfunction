...
execute if score mine.handler mine.stage.creaking matches 2 mine.handler mine.stage.hoglin matches 2 mine.handler mine.stage.warden matches 2 run function mine:unload