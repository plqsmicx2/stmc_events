setblock 0 -63 0 barrel{Items:[{Slot:0b,id:"minecraft:compass",count:1,components:{"minecraft:lodestone_tracker":{target:{dimension:"minecraft:overworld",pos:[I;0,0,0]},tracked:false}}}]}
