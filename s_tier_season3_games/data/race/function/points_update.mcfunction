...
# <===== SET ACTIONBAR =====>
execute as @a if score race.handler race.stage matches 3..4 if score @s race.laptime.seconds matches 0..9 run title @s actionbar [{score:{name:"@s",objective:"race.laptime.mins"},bold:true,color:"green"},{text:":0",color:"green"},{score:{name:"@s",objective:"race.laptime.seconds"},color:"green"}]
execute as @a if score race.handler race.stage matches 3..4 if score @s race.laptime.seconds matches 10.. run title @s actionbar [{score:{name:"@s",objective:"race.laptime.mins"},bold:true,color:"green"},{text:":",color:"green"},{score:{name:"@s",objective:"race.laptime.seconds"},color:"green"}]