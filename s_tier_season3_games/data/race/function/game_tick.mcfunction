...
execute in race:race as @a[x=-16, y=111, z=10, dx=7, dy=12, dz=10] at @s unless score @s race.laps_completed matches 4.. if score @s race.recentlyCompletedLap matches 0 run playsound minecraft:block.amethyst_cluster.break master @s ~ ~ ~
execute in race:race as @a[x=-16, y=111, z=10, dx=7, dy=12, dz=10] unless score @s race.laps_completed matches 4.. if score @s race.recentlyCompletedLap matches 0 run scoreboard players set @s race.recentlyCompletedLap 1
