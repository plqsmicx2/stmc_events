...
execute if entity @s[x=-1,y=103,z=-30,dx=6,dy=4,dz=1] run function race:update_placement
...
execute if entity @s[x=20,y=109,z=-31,dx=1,dy=3,dz=7] run function race:update_placement
...
execute if entity @s[x=-7,y=109,z=-40,dx=7,dy=5,dz=1] run function race:update_placement
...
execute if entity @s[x=-24,y=114,z=-34,dx=1,dy=3,dz=7] run function race:update_placement
...
execute if entity @s[x=-41,y=110,z=8,dx=3,dy=1,dz=5] run function race:update_placement
...
execute if entity @s[x=-28,y=110,z=-20,dx=1,dy=3,dz=7] run function race:update_placement
...
execute if entity @s[x=-8,y=113,z=-16,dx=5,dy=5,dz=1] run function race:update_placement
...
execute if entity @s[x=-17,y=126,z=-11,dx=7,dy=3,dz=1] run function race:update_placement
...
execute if entity @s[x=46,y=108,z=55,dx=6,dy=4,dz=1] run function race:update_placement

# CHECKPOINT #10 (last)
execute in race:race if entity @s[x=61,y=107,z=52,dx=7,dy=7,dz=4] run teleport @s -13 107 15 180 10
execute if entity @s[x=-16,y=104,z=10,dx=7,dy=7,dz=7] unless score @s race.checkpoints_completed matches 0 run scoreboard players add @s race.laps_completed 1
execute if entity @s[x=-16,y=104,z=10,dx=7,dy=7,dz=7] unless score @s race.checkpoints_completed matches 0 if score @s race.laptime.seconds matches 0..9 run tellraw @a [{selector:"@s"},{text:" completed lap #",color:green},{score:{name:"@s",objective:"race.laps_completed"},color:green},{text:" in ",color:green},{score:{name:"@s",objective:"race.laptime.mins"},color:"green"},{text:":0",color:"green"},{score:{name:"@s",objective:"race.laptime.seconds"},color:"green"}]
execute if entity @s[x=-16,y=104,z=10,dx=7,dy=7,dz=7] unless score @s race.checkpoints_completed matches 0 if score @s race.laptime.seconds matches 10.. run tellraw @a [{selector:"@s"},{text:" completed lap #",color:green},{score:{name:"@s",objective:"race.laps_completed"},color:green},{text:" in ",color:green},{score:{name:"@s",objective:"race.laptime.mins"},color:"green"},{text:":",color:"green"},{score:{name:"@s",objective:"race.laptime.seconds"},color:"green"}]
execute in race:race at @s if entity @s[x=-16,y=104,z=10,dx=7,dy=7,dz=7] unless score @s race.checkpoints_completed matches 0 run playsound minecraft:block.note_block.chime master @s ~ ~ ~ 1.2 0.8
execute if entity @s[x=-16,y=104,z=10,dx=7,dy=7,dz=7] run scoreboard players set @s race.checkpoints_completed 0
execute if entity @s[x=-16,y=104,z=10,dx=7,dy=7,dz=7] run function race:update_placement