...
execute if score race.handler race.timer.explanation matches 1 run tellraw @a {text:"---------------------------------------------------",color:"gray"}
...
# blurb #2
execute if score race.handler race.timer.explanation matches 160 run tellraw @a {text:"---------------------------------------------------",color:"gray"}
...
# blurb #3
execute if score race.handler race.timer.explanation matches 320 run tellraw @a {text:"---------------------------------------------------",color:"gray"}
...
# blurb #4
execute if score race.handler race.timer.explanation matches 480 run tellraw @a {text:"---------------------------------------------------",color:"gray"}
...
# blurb #5
execute if score race.handler race.timer.explanation matches 640 run tellraw @a {text:"---------------------------------------------------",color:"gray"}
...
# blurb #6
execute if score race.handler race.timer.explanation matches 799 run tellraw @a {text:"---------------------------------------------------",color:"gray"}
