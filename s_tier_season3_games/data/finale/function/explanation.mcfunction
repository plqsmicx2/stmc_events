...
execute if score finale.handler finale.timer.explanation matches 1 in finale:finale run tp @a 6 154 0 90 65
...
# blurb #2
execute if score finale.handler finale.timer.explanation matches 160 in finale:finale run tp @a 0 152 14 180 30
...
# blurb #3
execute if score finale.handler finale.timer.explanation matches 320 in finale:finale run tp @a 0 152 -14 0 30
...
# blurb #5
execute in finale:finale if score finale.handler finale.timer.explanation matches 480 run function finale:start_round
