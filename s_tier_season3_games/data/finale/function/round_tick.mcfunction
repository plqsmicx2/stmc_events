...
# replace glass
execute if score finale.handler finale.round.timer matches 400 in finale:finale run fill -3 146 -8 3 149 8 air replace #impermeable
...
execute if score finale.handler finale.round.timer matches 400.. if score finale.handler finale.stats.alive matches 1 run function finale:end_round