...
execute if score dungeons.handler dungeons.timer matches 18000 run function dungeons:unload
...
execute as @a if items entity @s hotbar.* ominous_trial_key run function dungeons:game/display/room_6
...
#execute as @a if items entity @s hotbar.* ominous_trial_key unless score BLUE_BEARS dungeons.room matches 1..8 unless score RED_RACCOONS dungeons.room matches 1..8 unless score CYAN_COUGARS dungeons.room matches 1..8 unless score GREEN_GOATS dungeons.room matches 1..8 unless score PURPLE_PENGUINS dungeons.room matches 1..8 unless score ORANGE_OTTERS dungeons.room matches 1..8 unless score YELLOW_YAKS dungeons.room matches 1..8 unless score PINK_PIKAS dungeons.room matches 1..8 run function dungeons:unload
