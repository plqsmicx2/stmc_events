...
yawp dim survival_games:sg1 delete-all regions
yawp dim survival_games:sg1 create local sg1-spawn Cuboid -10 174 -10 10 181 10
yawp local survival_games:sg1 sg1-spawn add flag no-pvp Allowed
yawp local survival_games:sg1 sg1-spawn add flag melee-players Denied
yawp local survival_games:sg1 sg1-spawn add flag no-hunger Allowed
yawp dim survival_games:sg1 create local sg1-world Cuboid -200 100 -200 200 200 200
yawp local survival_games:sg1 sg1-world add flag break-blocks Denied
yawp local survival_games:sg1 sg1-world add flag spawning-all Denied
yawp local survival_games:sg1 sg1-world add flag fall-damage Denied
