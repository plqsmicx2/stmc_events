...
# execute if score sg.r2.handler sg.r2.timer.round matches 1 run sudo plqsmic /pos1 -9 175 -9
# execute if score sg.r2.handler sg.r2.timer.round matches 1 run sudo plqsmic /pos2 9 180 9
# execute if score sg.r2.handler sg.r2.timer.round matches 2 run sudo plqsmic /replace red_wool green_wool
# in the meantime
execute if score sg.r2.handler sg.r2.timer.round matches 2 in survival_games:sg2 run tp @a 0 172 0
