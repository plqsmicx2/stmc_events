...
execute as @a[team=RED_RACCOONS] if score sg.RedRaccoons sg.r2.teamPlacement matches 1 run scoreboard players operation @s sg.r2.teamPlacementPoints += sg.handler sg.points.topOneTeamValue
execute as @a[team=RED_RACCOONS] if score sg.RedRaccoons sg.r2.teamPlacement matches 2 run scoreboard players operation @s sg.r2.teamPlacementPoints += sg.handler sg.points.topTwoTeamValue
execute as @a[team=RED_RACCOONS] if score sg.RedRaccoons sg.r2.teamPlacement matches 3 run scoreboard players operation @s sg.r2.teamPlacementPoints += sg.handler sg.points.topThreeTeamValue
...
execute as @a[team=ORANGE_OTTERS] if score sg.OrangeOtters sg.r2.teamPlacement matches 3 run scoreboard players operation @s sg.r2.teamPlacementPoints += sg.handler sg.points.topThreeTeamValue
...
execute as @a[team=PINK_PIKAS] if score sg.PinkPikas sg.r2.teamPlacement matches 3 run scoreboard players operation @s sg.r2.teamPlacementPoints += sg.handler sg.points.topThreeTeamValue
...
execute as @a[team=GREEN_GOATS] if score sg.GreenGoats sg.r2.teamPlacement matches 3 run scoreboard players operation @s sg.r2.teamPlacementPoints += sg.handler sg.points.topThreeTeamValue
...
execute as @a[team=CYAN_COUGARS] if score sg.CyanCougars sg.r2.teamPlacement matches 3 run scoreboard players operation @s sg.r2.teamPlacementPoints += sg.handler sg.points.topThreeTeamValue
...
execute as @a[team=PURPLE_PENGUINS] if score sg.PurplePenguins sg.r2.teamPlacement matches 3 run scoreboard players operation @s sg.r2.teamPlacementPoints += sg.handler sg.points.topThreeTeamValue
