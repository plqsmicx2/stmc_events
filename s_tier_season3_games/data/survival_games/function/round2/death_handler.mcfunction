...
execute if score sg.YellowYaks sg.players_alive matches 0 unless score sg.YellowYaks sg.r2.teamPlacement matches 1..6 run scoreboard players operation sg.YellowYaks sg.r2.teamPlacement = sg.r2.handler sg.r2.currentPlacement
...
execute if score sg.BlueBears sg.players_alive matches 0 unless score sg.BlueBears sg.r2.teamPlacement matches 1..6 run scoreboard players operation sg.BlueBears sg.r2.teamPlacement = sg.r2.handler sg.r2.currentPlacement