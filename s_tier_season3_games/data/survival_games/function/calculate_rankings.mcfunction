...
# set our highest value to -1
scoreboard players set $stmc.highest sg.points.indiv.temp -1

# then determine the highest value
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp

# then determine which player has that highest value & give them the highest rank applicable
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 1
...
scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 2
execute as @a if score @s sg.points.indiv.rank matches 2 run scoreboard players reset @s sg.points.indiv.temp

scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 3
execute as @a if score @s sg.points.indiv.rank matches 3 run scoreboard players reset @s sg.points.indiv.temp

scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 4
execute as @a if score @s sg.points.indiv.rank matches 4 run scoreboard players reset @s sg.points.indiv.temp

scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 5
execute as @a if score @s sg.points.indiv.rank matches 5 run scoreboard players reset @s sg.points.indiv.temp

scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 6
execute as @a if score @s sg.points.indiv.rank matches 6 run scoreboard players reset @s sg.points.indiv.temp

scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 7
execute as @a if score @s sg.points.indiv.rank matches 7 run scoreboard players reset @s sg.points.indiv.temp

scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 8
execute as @a if score @s sg.points.indiv.rank matches 8 run scoreboard players reset @s sg.points.indiv.temp

scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 9
execute as @a if score @s sg.points.indiv.rank matches 9 run scoreboard players reset @s sg.points.indiv.temp

scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 10
execute as @a if score @s sg.points.indiv.rank matches 10 run scoreboard players reset @s sg.points.indiv.temp

scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 11
execute as @a if score @s sg.points.indiv.rank matches 11 run scoreboard players reset @s sg.points.indiv.temp

scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 12
execute as @a if score @s sg.points.indiv.rank matches 12 run scoreboard players reset @s sg.points.indiv.temp

scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 13
execute as @a if score @s sg.points.indiv.rank matches 13 run scoreboard players reset @s sg.points.indiv.temp

scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 14
execute as @a if score @s sg.points.indiv.rank matches 14 run scoreboard players reset @s sg.points.indiv.temp

scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 15
execute as @a if score @s sg.points.indiv.rank matches 15 run scoreboard players reset @s sg.points.indiv.temp

scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 16
execute as @a if score @s sg.points.indiv.rank matches 16 run scoreboard players reset @s sg.points.indiv.temp

scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 17
execute as @a if score @s sg.points.indiv.rank matches 17 run scoreboard players reset @s sg.points.indiv.temp

scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 18
execute as @a if score @s sg.points.indiv.rank matches 18 run scoreboard players reset @s sg.points.indiv.temp

scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 19
execute as @a if score @s sg.points.indiv.rank matches 19 run scoreboard players reset @s sg.points.indiv.temp

scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 20
execute as @a if score @s sg.points.indiv.rank matches 20 run scoreboard players reset @s sg.points.indiv.temp

scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 21
execute as @a if score @s sg.points.indiv.rank matches 21 run scoreboard players reset @s sg.points.indiv.temp

scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 22
execute as @a if score @s sg.points.indiv.rank matches 22 run scoreboard players reset @s sg.points.indiv.temp

scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 23
execute as @a if score @s sg.points.indiv.rank matches 23 run scoreboard players reset @s sg.points.indiv.temp

scoreboard players set $stmc.highest sg.points.indiv.temp -1
execute as @a run scoreboard players operation $stmc.highest sg.points.indiv.temp > @s sg.points.indiv.temp
execute as @a if score @s sg.points.indiv.temp = $stmc.highest sg.points.indiv.temp unless score @s sg.points.indiv.rank matches 0.. run scoreboard players set @s sg.points.indiv.rank 24
