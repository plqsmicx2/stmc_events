...
execute as @a[scores={sg.alive=1..}] if score @s sg.r3.death matches 1.. run scoreboard players set @s sg.alive 0
...
execute if score sg.YellowYaks sg.players_alive matches 1..4 run scoreboard players add sg.r3.handler sg.teams_alive 1
...
execute if score sg.BlueBears sg.players_alive matches 1..4 run scoreboard players add sg.r3.handler sg.teams_alive 1
