...
execute as @a run scoreboard players operation @s sg.r3.killPoints = @s sg.r3.kills

# then multiply that value by how much each kill is worth
execute as @a run scoreboard players operation @s sg.r3.killPoints *= sg.handler sg.points.killValue
...
# reset to 0
execute as @a run scoreboard players set @s sg.r3.points 0

# sum killPoints & indivPlacementPoints for players

execute as @a run scoreboard players operation @s sg.r3.points += @s sg.r3.killPoints
execute as @a run scoreboard players operation @s sg.r3.points += @s sg.r3.indivPlacementPoints
execute as @a run scoreboard players operation @s sg.r3.points += @s sg.r3.teamPlacementPoints
...
scoreboard players set sg.RedRaccoons sg.r3.points 0
execute as @a[team=RED_RACCOONS] at @s run scoreboard players operation sg.RedRaccoons sg.r3.points += @s sg.r3.points
...
scoreboard players operation sg.RedRaccoons sg.points.team += sg.RedRaccoons sg.r3.points

scoreboard players set sg.OrangeOtters sg.r3.points 0
execute as @a[team=ORANGE_OTTERS] at @s run scoreboard players operation sg.OrangeOtters sg.r3.points += @s sg.r3.points
...
scoreboard players operation sg.OrangeOtters sg.points.team += sg.OrangeOtters sg.r3.points

scoreboard players set sg.PinkPikas sg.r3.points 0
execute as @a[team=PINK_PIKAS] at @s run scoreboard players operation sg.PinkPikas sg.r3.points += @s sg.r3.points
...
scoreboard players operation sg.PinkPikas sg.points.team += sg.PinkPikas sg.r3.points

scoreboard players set sg.GreenGoats sg.r3.points 0
execute as @a[team=GREEN_GOATS] at @s run scoreboard players operation sg.GreenGoats sg.r3.points += @s sg.r3.points
...
scoreboard players operation sg.GreenGoats sg.points.team += sg.GreenGoats sg.r3.points

scoreboard players set sg.CyanCougars sg.r3.points 0
execute as @a[team=CYAN_COUGARS] at @s run scoreboard players operation sg.CyanCougars sg.r3.points += @s sg.r3.points
...
scoreboard players operation sg.CyanCougars sg.points.team += sg.CyanCougars sg.r3.points

scoreboard players set sg.PurplePenguins sg.r3.points 0
execute as @a[team=PURPLE_PENGUINS] at @s run scoreboard players operation sg.PurplePenguins sg.r3.points += @s sg.r3.points
...
scoreboard players operation sg.PurplePenguins sg.points.team += sg.PurplePenguins sg.r3.points

# <===== Kills Actionbar =====>

# sets player actionbar to their # of kills
execute as @a if score sg.r3.handler sg.r3.stage matches 3..4 run title @s actionbar ["",{text:"Kills: ",bold:true,color:"yellow"},{score:{name:"@s",objective:"sg.r3.kills"},bold:true,color:"red"},{text:"   |   Players Alive: ",bold:true,color:"yellow"},{score:{name:"sg.r3.handler",objective:"sg.players_alive"},bold:true,color:"red"},{text:"   |   Individual Points: ",bold:true,color:"yellow"},{score:{name:"@s",objective:"sg.points.indiv"},bold:true,color:"red"}]