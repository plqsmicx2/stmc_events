...
execute in survival_games:sg3 if score sg.r3.handler sg.r3.timer.round matches 1 run summon armor_stand 0 200 0 {NoGravity:1b,Silent:1b,Invulnerable:1b,HasVisualFire:0b,Glowing:0b,Invisible:1b,Tags:["sg.r3.worldborder.center"]}
...
execute in survival_games:sg3 if score sg.r3.handler sg.r3.borderStage matches 1 run worldborder add -0.125

# migrate about 0.04167 blocks each tick in the appropriate direction
# this is achieved by moving our custom armor stand
execute in survival_games:sg3 as @e[tag=sg.r3.worldborder.center] if score sg.r3.handler sg.r3.borderStage matches 1 if score sg.r3.handler sg.borderEnd matches 1 at @s run tp @s ~-0.04208 ~ ~-0.04208
execute in survival_games:sg3 as @e[tag=sg.r3.worldborder.center] if score sg.r3.handler sg.r3.borderStage matches 1 if score sg.r3.handler sg.borderEnd matches 2 at @s run tp @s ~0.04125 ~ ~-0.04208
execute in survival_games:sg3 as @e[tag=sg.r3.worldborder.center] if score sg.r3.handler sg.r3.borderStage matches 1 if score sg.r3.handler sg.borderEnd matches 3 at @s run tp @s ~-0.04208 ~ ~0.04125
execute in survival_games:sg3 as @e[tag=sg.r3.worldborder.center] if score sg.r3.handler sg.r3.borderStage matches 1 if score sg.r3.handler sg.borderEnd matches 4 at @s run tp @s ~0.04125 ~ ~0.04125
# and then updating the center based on the coordinates of that armor stand
execute in survival_games:sg3 as @e[tag=sg.r3.worldborder.center] if score sg.r3.handler sg.r3.borderStage matches 1 at @s run worldborder center ~ ~
...
execute in survival_games:sg3 if score sg.r3.handler sg.r3.borderStage matches 3 run worldborder add -0.0833
...
execute in survival_games:sg3 if score sg.r3.handler sg.r3.borderStage matches 5 run worldborder add -0.075
