...
execute if score sg.r3.handler sg.r3.stage matches 4 if score sg.r3.handler sg.r3.timer.delay3 matches 600.. run scoreboard players add stmc.handler event.stage 1