...
# reset chest loot
execute in stmc:lobby/main run fill -60 60 -80 60 160 110 chest[facing=north]{LootTable:"stmc:lobby/chest"} replace chest[facing=north]
execute in stmc:lobby/main run fill -60 60 -80 60 160 110 chest[facing=east]{LootTable:"stmc:lobby/chest"} replace chest[facing=east]
execute in stmc:lobby/main run fill -60 60 -80 60 160 110 chest[facing=south]{LootTable:"stmc:lobby/chest"} replace chest[facing=south]
execute in stmc:lobby/main run fill -60 60 -80 60 160 110 chest[facing=west]{LootTable:"stmc:lobby/chest"} replace chest[facing=west]
# reset copper chest loot
execute in stmc:lobby/main run fill -60 60 -80 60 160 110 copper_chest[facing=north]{LootTable:"stmc:lobby/chest"} replace copper_chest[facing=north]
execute in stmc:lobby/main run fill -60 60 -80 60 160 110 copper_chest[facing=east]{LootTable:"stmc:lobby/chest"} replace copper_chest[facing=east]
execute in stmc:lobby/main run fill -60 60 -80 60 160 110 copper_chest[facing=south]{LootTable:"stmc:lobby/chest"} replace copper_chest[facing=south]
execute in stmc:lobby/main run fill -60 60 -80 60 160 110 copper_chest[facing=west]{LootTable:"stmc:lobby/chest"} replace copper_chest[facing=west]
