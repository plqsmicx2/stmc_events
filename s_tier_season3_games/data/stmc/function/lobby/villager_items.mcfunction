...
#tipped arrows
execute if items entity @s hotbar.* tipped_arrow[tooltip_display={hide_tooltip:true}] run loot give @s loot stmc:lobby/jan26/category/arrows
...
#horns
execute if items entity @s hotbar.* goat_horn[tooltip_display={hide_tooltip:true}] run loot give @s loot stmc:lobby/jan26/category/horns
...
#potions
execute if items entity @s hotbar.* potion[tooltip_display={hide_tooltip:true}] run loot give @s loot stmc:lobby/jan26/category/potions
...
#suspicious stews
execute if items entity @s hotbar.* suspicious_stew[tooltip_display={hide_tooltip:true}] run loot give @s loot stmc:lobby/jan26/category/suspicious
...
#trial key
execute if items entity @s hotbar.* trial_key run loot give @s loot stmc:lobby/jan26/copper_chest
execute if items entity @s hotbar.* trial_key run clear @s trial_key 1

#ominous trial key
execute if items entity @s hotbar.* ominous_trial_key run loot give @s loot stmc:lobby/jan26/oxidized_chest
