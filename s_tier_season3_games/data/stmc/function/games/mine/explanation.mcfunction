...
execute in stmc:mine/lobby if score mine.handler mine.timer.explanation matches 1 run teleport @a -4 100 0 -90 0
...
# blurb #2
execute in stmc:mine/lobby if score mine.handler mine.timer.explanation matches 160 run teleport @a 4 100 14 -135 0
...
# blurb #3
execute in stmc:mine/lobby if score mine.handler mine.timer.explanation matches 320 run teleport @a 21 100 24 45 0
...
# blurb #4
execute in stmc:mine/lobby if score mine.handler mine.timer.explanation matches 480 run teleport @a 43 100 5 -155 0
...
execute in stmc:mine/lobby if score mine.handler mine.timer.explanation matches 639 run teleport @a 0 101 0 0 0
