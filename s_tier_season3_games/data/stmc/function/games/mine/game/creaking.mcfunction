...
execute if score mine.handler mine.timer matches 1220 run function stmc:games/mine/mobs/creaking with storage mine:data
execute if score mine.handler mine.timer matches 1240 run function stmc:games/mine/mobs/creaking with storage mine:data
execute if score mine.handler mine.timer matches 1260 run function stmc:games/mine/mobs/creaking with storage mine:data
execute if score mine.handler mine.timer matches 1280 run function stmc:games/mine/mobs/creaking with storage mine:data
execute if score mine.handler mine.timer matches 1300 run function stmc:games/mine/mobs/creaking with storage mine:data
...
execute if score mine.handler mine.timer matches 1500 run function stmc:games/mine/mobs/creaking with storage mine:data
execute if score mine.handler mine.timer matches 1520 run function stmc:games/mine/mobs/creaking with storage mine:data
execute if score mine.handler mine.timer matches 1540 run function stmc:games/mine/mobs/creaking with storage mine:data
execute if score mine.handler mine.timer matches 1560 run function stmc:games/mine/mobs/creaking with storage mine:data
execute if score mine.handler mine.timer matches 1580 run function stmc:games/mine/mobs/creaking with storage mine:data
execute if score mine.handler mine.timer matches 1600 run function stmc:games/mine/mobs/creaking with storage mine:data
execute if score mine.handler mine.timer matches 1620 run function stmc:games/mine/mobs/creaking with storage mine:data
execute if score mine.handler mine.timer matches 1640 run function stmc:games/mine/mobs/creaking with storage mine:data
execute if score mine.handler mine.timer matches 1660 run function stmc:games/mine/mobs/creaking with storage mine:data
execute if score mine.handler mine.timer matches 1680 run function stmc:games/mine/mobs/creaking with storage mine:data
execute if score mine.handler mine.timer matches 1700 run function stmc:games/mine/mobs/creaking with storage mine:data
