...
{PersistenceRequired:1b,Invulnerable:1b,attributes:[{id:"minecraft:attack_damage",base:8},{id:"minecraft:movement_efficiency",base:0.0001},{id:"minecraft:movement_speed",base:0.5}],DeathLootTable:"minecraft:empty"}
