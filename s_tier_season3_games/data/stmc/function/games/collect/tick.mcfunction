...
function stmc:games/collect/sidebar with storage stmc:global
...
execute if score collect.handler collect.stage matches 1 run function stmc:games/collect/explanation
...
# start game
execute if score collect.handler collect.stage matches 2 if score collect.handler collect.timer.delay2 matches 200.. run function stmc:games/collect/helper/give_items
...
execute if score collect.handler collect.stage matches 2 if score collect.handler collect.timer.delay2 matches 400.. run function stmc:games/collect/start_game
...
execute if score collect.handler collect.stage matches 3 run function stmc:games/collect/game_tick
...
execute if score collect.handler collect.stage matches 4 if score collect.handler collect.timer.delay3 matches 100 run function stmc:games/collect/team_announcements with storage stmc:global
execute if score collect.handler collect.stage matches 4 if score collect.handler collect.timer.delay3 matches 200.. run function stmc:games/collect/reset