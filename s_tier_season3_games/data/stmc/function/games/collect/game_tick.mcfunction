...
execute if score collect.handler collect.timer.game matches 14400 run function stmc:games/collect/end_game

# update players' item tracker
function stmc:games/collect/helper/item_check

# and check if teams should get a placement
function stmc:games/collect/helper/item_award