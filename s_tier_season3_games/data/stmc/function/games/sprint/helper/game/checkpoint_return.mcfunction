...
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 1 \
        if score @s sprint.stats.currentDifficulty matches 1 run tp @s -18.46 101.00 15.51 94.44 8.55
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 1 \
        if score @s sprint.stats.currentDifficulty matches 2 run tp @s -17.96 101.00 -0.02 450.63 1.43
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 1 \
        if score @s sprint.stats.currentDifficulty matches 3 run tp @s -18.39 101.00 -15.54 462.93 7.95

# Level #2:
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 2 \
        if score @s sprint.stats.currentDifficulty matches 1 run tp @s -49.40 101.00 16.52 -1350.21 5.55
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 2 \
        if score @s sprint.stats.currentDifficulty matches 2 run tp @s -52.63 101.00 1.51 450.48 12.68
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 2 \
        if score @s sprint.stats.currentDifficulty matches 3 run tp @s -49.61 101.00 -16.85 450.78 16.35

# Level #3:
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 3 \
        if score @s sprint.stats.currentDifficulty matches 1 run tp @s -82.95 101.00 16.02 89.79 9.45
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 3 \
        if score @s sprint.stats.currentDifficulty matches 2 run tp @s -84.55 101.00 0.55 451.38 30.38
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 3 \
        if score @s sprint.stats.currentDifficulty matches 3 run tp @s -81.68 101.00 -16.44 450.63 -0.15

# Level #4:
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 4 \
        if score @s sprint.stats.currentDifficulty matches 1 run tp @s -113.97 101.00 16.48 89.64 1.35
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 4 \
        if score @s sprint.stats.currentDifficulty matches 2 run tp @s -115.19 101.00 0.48 450.03 15.08
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 4 \
        if score @s sprint.stats.currentDifficulty matches 3 run tp @s -114.34 101.00 -14.48 466.98 0.15

# Level #5:
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 5 \
        if score @s sprint.stats.currentDifficulty matches 1 run tp @s -146.30 101.00 14.92 90.24 9.45
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 5 \
        if score @s sprint.stats.currentDifficulty matches 2 run tp @s -147.09 101.00 -0.00 450.63 13.28
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 5 \
        if score @s sprint.stats.currentDifficulty matches 3 run tp @s -145.13 101.00 -16.27 448.98 10.95

# Level #6:
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 6 \
        if score @s sprint.stats.currentDifficulty matches 1 run tp @s -177.27 101.00 16.46 90.52 4.25
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 6 \
        if score @s sprint.stats.currentDifficulty matches 2 run tp @s -178.03 101.00 0.49 450.18 13.65
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 6 \
        if score @s sprint.stats.currentDifficulty matches 3 run tp @s -178.30 101.00 -15.92 449.88 14.85

# Level #7:
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 7 \
        if score @s sprint.stats.currentDifficulty matches 1 run tp @s -209.50 101.00 16.45 90.22 10.40
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 7 \
        if score @s sprint.stats.currentDifficulty matches 2 run tp @s -210.00 101.00 0.49 450.63 14.70
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 7 \
        if score @s sprint.stats.currentDifficulty matches 3 run tp @s -210.17 101.00 -15.45 450.48 4.65

# Level #8:
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 8 \
        if score @s sprint.stats.currentDifficulty matches 1 run tp @s -241.93 101.00 16.49 88.27 9.30
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 8 \
        if score @s sprint.stats.currentDifficulty matches 2 run tp @s -242.24 101.00 0.52 450.33 0.45
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 8 \
        if score @s sprint.stats.currentDifficulty matches 3 run tp @s -243.01 101.00 -15.50 450.33 6.00

# Level #9:
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 9 \
        if score @s sprint.stats.currentDifficulty matches 1 run tp @s -274.19 101.00 15.99 89.92 4.05
execute if score @s sprint.stats.currentSection matches 1 if score @s sprint.stats.currentCheckpoint matches 9 \
