...
execute as @a[team=BLUE_BEARS] if items entity @s inventory.* ominous_trial_key run scoreboard players set BLUE_BEARS dungeons.room 9
execute as @a[team=RED_RACCOONS] if items entity @s inventory.* ominous_trial_key run scoreboard players set RED_RACCOONS dungeons.room 9
execute as @a[team=CYAN_COUGARS] if items entity @s inventory.* ominous_trial_key run scoreboard players set CYAN_COUGARS dungeons.room 9
execute as @a[team=GREEN_GOATS] if items entity @s inventory.* ominous_trial_key run scoreboard players set GREEN_GOATS dungeons.room 9
execute as @a[team=PURPLE_PENGUINS] if items entity @s inventory.* ominous_trial_key run scoreboard players set PURPLE_PENGUINS dungeons.room 9
execute as @a[team=ORANGE_OTTERS] if items entity @s inventory.* ominous_trial_key run scoreboard players set ORANGE_OTTERS dungeons.room 9
execute as @a[team=YELLOW_YAKS] if items entity @s inventory.* ominous_trial_key run scoreboard players set YELLOW_YAKS dungeons.room 9
execute as @a[team=PINK_PIKAS] if items entity @s inventory.* ominous_trial_key run scoreboard players set PINK_PIKAS dungeons.room 9
