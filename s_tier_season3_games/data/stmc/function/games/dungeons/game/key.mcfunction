...
execute as @a if items entity @s inventory.* trial_key at @s store success score @s dungeons.glass run fill ~-20 ~-3 ~3 ~20 ~4 ~3 air replace tinted_glass
execute as @a[scores={dungeons.glass=1..}] if items entity @s inventory.* trial_key at @s run playsound block.glass.break block @a ~ ~ ~3 .5 .9 0
