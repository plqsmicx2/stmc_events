...
execute in stmc:delve/main as @a[team=RED_RACCOONS] run teleport @s 0 93 0
execute in stmc:delve/main as @a[team=RED_RACCOONS] run spawnpoint @s 0 93 0
execute in stmc:delve/main as @a[team=ORANGE_OTTERS] run teleport @s 0 123 0
execute in stmc:delve/main as @a[team=ORANGE_OTTERS] run spawnpoint @s 0 123 0
execute in stmc:delve/main as @a[team=PINK_PIKAS] run teleport @s 0 153 0
execute in stmc:delve/main as @a[team=PINK_PIKAS] run spawnpoint @s 0 153 0
execute in stmc:delve/main as @a[team=GREEN_GOATS] run teleport @s 0 183 0
execute in stmc:delve/main as @a[team=GREEN_GOATS] run spawnpoint @s 0 183 0
execute in stmc:delve/main as @a[team=CYAN_COUGARS] run teleport @s 0 213 0
execute in stmc:delve/main as @a[team=CYAN_COUGARS] run spawnpoint @s 0 213 0
execute in stmc:delve/main as @a[team=PURPLE_PENGUINS] run teleport @s 0 243 0
execute in stmc:delve/main as @a[team=PURPLE_PENGUINS] run spawnpoint @s 0 243 0
