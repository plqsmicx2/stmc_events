...
execute in stmc:delve/main if score delve.handler delve.timer.explanation matches 1 run tp @a -25 92 0.0 90 10
...
# blurb #2
execute in stmc:delve/main if score delve.handler delve.timer.explanation matches 160 run tp @a -36 94 41 -40 10
...
# blurb #3
execute in stmc:delve/main if score delve.handler delve.timer.explanation matches 320 run tp @a -4 92 0.0 -90 25
...
# blurb #4
execute in stmc:delve/main if score delve.handler delve.timer.explanation matches 480 run tp @a 1.0 91 -35 180 25
...
# blurb #5
execute in stmc:delve/main if score delve.handler delve.timer.explanation matches 640 run tp @a 44 93 -101 -45 10
...
# blurb #6
execute in stmc:delve/main if score delve.handler delve.timer.explanation matches 799 run tp @a[team=RED_RACCOONS] 0 93 0 -90 15
execute in stmc:delve/main if score delve.handler delve.timer.explanation matches 799 run tp @a[team=ORANGE_OTTERS] 0 123 0 -90 15
execute in stmc:delve/main if score delve.handler delve.timer.explanation matches 799 run tp @a[team=PINK_PIKAS] 0 153 0 -90 15
execute in stmc:delve/main if score delve.handler delve.timer.explanation matches 799 run tp @a[team=GREEN_GOATS] 0 183 0 -90 15
execute in stmc:delve/main if score delve.handler delve.timer.explanation matches 799 run tp @a[team=CYAN_COUGARS] 0 213 0 -90 15
execute in stmc:delve/main if score delve.handler delve.timer.explanation matches 799 run tp @a[team=PURPLE_PENGUINS] 0 243 0 -90 15
