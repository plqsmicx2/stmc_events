...
# every tick stuff
execute in stmc:trials/towers run kill @e[type=minecraft:item]
...
# spawn powder
execute in stmc:trials/towers as @a[team=RED_RACCOONS,scores={towers.alive=1}] at @s if score towers.handler towers.timer.game.summon matches 4 run setblock ~ ~4 ~ minecraft:red_concrete_powder
execute in stmc:trials/towers as @a[team=ORANGE_OTTERS,scores={towers.alive=1}] at @s if score towers.handler towers.timer.game.summon matches 4 run setblock ~ ~4 ~ minecraft:orange_concrete_powder
execute in stmc:trials/towers as @a[team=PINK_PIKAS,scores={towers.alive=1}] at @s if score towers.handler towers.timer.game.summon matches 4 run setblock ~ ~4 ~ minecraft:pink_concrete_powder
execute in stmc:trials/towers as @a[team=YELLOW_YAKS,scores={towers.alive=1}] at @s if score towers.handler towers.timer.game.summon matches 4 run setblock ~ ~4 ~ minecraft:yellow_concrete_powder
execute in stmc:trials/towers as @a[team=GREEN_GOATS,scores={towers.alive=1}] at @s if score towers.handler towers.timer.game.summon matches 4 run setblock ~ ~4 ~ minecraft:green_concrete_powder
execute in stmc:trials/towers as @a[team=CYAN_COUGARS,scores={towers.alive=1}] at @s if score towers.handler towers.timer.game.summon matches 4 run setblock ~ ~4 ~ minecraft:cyan_concrete_powder
execute in stmc:trials/towers as @a[team=PURPLE_PENGUINS,scores={towers.alive=1}] at @s if score towers.handler towers.timer.game.summon matches 4 run setblock ~ ~4 ~ minecraft:purple_concrete_powder
execute in stmc:trials/towers as @a[team=BLUE_BEARS,scores={towers.alive=1}] at @s if score towers.handler towers.timer.game.summon matches 4 run setblock ~ ~4 ~ minecraft:blue_concrete_powder
...
# no players alive
execute if score towers.handler towers.players_alive matches 0 run function stmc:games/trials/towers/game_end

# 3 minutes elapsed
execute if score towers.handler towers.timer.game matches 3600.. run function stmc:games/trials/towers/game_end