...
execute in stmc:trials/towers if score towers.handler towers.timer.explanation matches 1 run tp @a 10 115 10 135 25
...
execute in stmc:trials/towers if score towers.handler towers.timer.explanation matches 160 run tp @a -15 109 14 -135 4
...
execute in stmc:trials/towers if score towers.handler towers.timer.explanation matches 320 run tp @a 0 125 0 180 90
...
# blurb #4
execute in stmc:trials/towers if score towers.handler towers.timer.explanation matches 480 run tp @a 0 107 -16 0 10
...
# blurb #5
execute in stmc:trials/towers if score towers.handler towers.timer.explanation matches 640 run tp @a 0 105 0 -180 10
execute in stmc:trials/towers if score towers.handler towers.timer.explanation matches 640 run gamemode adventure @a
execute in stmc:trials/towers if score towers.handler towers.timer.explanation matches 640 run gamemode spectator @a[team=SPECTATORS]
