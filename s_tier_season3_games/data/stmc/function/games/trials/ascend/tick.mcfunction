...
execute unless score ascend.handler ascend.stage matches 0.. run function stmc:games/trials/ascend/load
...
# update sidebar
function stmc:games/trials/ascend/points_update
function stmc:games/trials/ascend/sidebar with storage stmc:global
...
# automatically pause
execute unless score ascend.handler ascend.stage matches 3 run function stmc:thread/helper/automatic_pause
...
# reset world
execute if score ascend.handler ascend.timer.delay1 matches 1..50 run function stmc:games/trials/ascend/reset_world

# clone builds
execute in stmc:trials/ascend if score ascend.handler ascend.timer.delay1 matches 5 \
        run clone -49 90 -49 49 220 49 -149 90 -149
execute in stmc:trials/ascend if score ascend.handler ascend.timer.delay1 matches 10 \
        run clone -49 90 -49 49 220 49 -49 90 -149
execute in stmc:trials/ascend if score ascend.handler ascend.timer.delay1 matches 15 \
        run clone -49 90 -49 49 220 49 51 90 -149
execute in stmc:trials/ascend if score ascend.handler ascend.timer.delay1 matches 20 \
        run clone -49 90 -49 49 220 49 51 90 -49
execute in stmc:trials/ascend if score ascend.handler ascend.timer.delay1 matches 25 \
        run clone -49 90 -49 49 220 49 51 90 51
execute in stmc:trials/ascend if score ascend.handler ascend.timer.delay1 matches 30 \
        run clone -49 90 -49 49 220 49 -49 90 51
execute in stmc:trials/ascend if score ascend.handler ascend.timer.delay1 matches 35 \
        run clone -49 90 -49 49 220 49 -149 90 51
execute in stmc:trials/ascend if score ascend.handler ascend.timer.delay1 matches 40 \
        run clone -49 90 -49 49 220 49 -149 90 -49
execute in stmc:trials/ascend if score ascend.handler ascend.timer.delay1 matches 45 \
        run clone -49 90 -49 49 220 49 -149 90 -149
execute in stmc:trials/ascend if score ascend.handler ascend.timer.delay1 matches 50 \
        run clone -49 90 -49 49 220 49 -49 90 -149
execute in stmc:trials/ascend if score ascend.handler ascend.timer.delay1 matches 55 \
        run clone -49 90 -49 49 220 49 51 90 -149
execute in stmc:trials/ascend if score ascend.handler ascend.timer.delay1 matches 60 \
        run clone -49 90 -49 49 220 49 51 90 -49
execute in stmc:trials/ascend if score ascend.handler ascend.timer.delay1 matches 65 \
        run clone -49 90 -49 49 220 49 51 90 51
execute in stmc:trials/ascend if score ascend.handler ascend.timer.delay1 matches 70 \
        run clone -49 90 -49 49 220 49 -49 90 51
execute in stmc:trials/ascend if score ascend.handler ascend.timer.delay1 matches 75 \
        run clone -49 90 -49 49 220 49 -149 90 51
execute in stmc:trials/ascend if score ascend.handler ascend.timer.delay1 matches 80 \
        run clone -49 90 -49 49 220 49 -149 90 -49
...
# run explanation
execute if score ascend.handler ascend.stage matches 1 run function stmc:games/trials/ascend/explanation
...
# update stage
execute if score ascend.handler ascend.stage matches 2 if score ascend.handler ascend.timer.delay2 matches 400.. run function stmc:games/trials/ascend/start_game
...
# run game
execute if score ascend.handler ascend.stage matches 3 run function stmc:games/trials/ascend/game_tick
...
execute if score ascend.handler ascend.timer.delay3 matches 100 run \
        function stmc:games/trials/ascend/team_announcements with storage stmc:global
...
execute if score ascend.handler ascend.stage matches 4 if score ascend.handler ascend.timer.delay3 matches 200.. run \
        function stmc:games/trials/ascend/reset