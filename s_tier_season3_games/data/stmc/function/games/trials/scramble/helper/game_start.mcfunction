# helper function that runs some items & standardizes scoreboards at the start of the game

# start game
scoreboard players set scramble.handler scramble.stage 3

# start music
execute in stmc:trials/scramble run playsound music_disc.otherside master @a 0 116 0 0.9

# create bossbar
bossbar add scramble.timer [{text:"Round Length",color:"dark_aqua"}]
...
execute as @a unless entity @s[team=SPECTATORS] run scoreboard players set @s scramble.alive 1
