...
execute as @a at @s in stmc:trials/spleef run spawnpoint @s ~ ~ ~

# if the player falls into this region, kill them
execute in stmc:trials/spleef as @a[scores={spleef.alive=1},x=-30,y=60,z=-30,dx=60,dy=30,dz=60] run scoreboard players set spleef.handler spleef.deathThisTick 1
execute in stmc:trials/spleef as @a[scores={spleef.alive=1},x=-30,y=60,z=-30,dx=60,dy=30,dz=60] run playsound minecraft:entity.player.death master @s ~ ~ ~
execute in stmc:trials/spleef as @a[scores={spleef.alive=1},x=-30,y=60,z=-30,dx=60,dy=30,dz=60] run gamemode spectator @s
execute in stmc:trials/spleef as @a[scores={spleef.alive=1},x=-30,y=60,z=-30,dx=60,dy=30,dz=60] run tellraw @a ["",{selector:"@s"},{text:" took a tumble!",color:"white"}]
execute in stmc:trials/spleef as @a[scores={spleef.alive=1},x=-30,y=60,z=-30,dx=60,dy=30,dz=60] run scoreboard players set @s spleef.alive 0
...
function stmc:games/trials/spleef/helper/points_announcements
