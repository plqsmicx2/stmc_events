...
execute in stmc:blitz if score blitz.handler blitz.timer.delay1 matches 2 run function stmc:games/blitz/reset_world
...
execute if score blitz.handler blitz.stage matches 1 run function stmc:games/blitz/explanation
...
execute if score blitz.handler blitz.stage matches 2 if score blitz.handler blitz.timer.delay2 matches 400.. run function stmc:games/blitz/start_game
...
execute if score blitz.handler blitz.stage matches 4 if score blitz.handler blitz.timer.delay3 matches 100 run function stmc:games/blitz/player_announcements
execute if score blitz.handler blitz.stage matches 4 if score blitz.handler blitz.timer.delay3 matches 300 run function stmc:games/blitz/team_announcements with storage stmc:global
