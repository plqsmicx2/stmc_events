...
# blurb #2
execute if score blitz.handler blitz.timer.explanation matches 160 in stmc:blitz run teleport @a -3 101 108 -20 20
...
# blurb #3
execute if score blitz.handler blitz.timer.explanation matches 320 in stmc:blitz run teleport @a -29 115 41 145 -5
...
# blurb #4
execute if score blitz.handler blitz.timer.explanation matches 480 in stmc:blitz run teleport @a 40 106 93 45 10
...
# blurb #5
execute if score blitz.handler blitz.timer.explanation matches 640 in stmc:blitz run teleport @a 0 130 60 180 30
...
# blurb #6
execute if score blitz.handler blitz.timer.explanation matches 799 in stmc:blitz run teleport @a 0 172 0
