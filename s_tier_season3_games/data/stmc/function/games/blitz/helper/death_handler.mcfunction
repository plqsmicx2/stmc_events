...
execute if score blitz.handler blitz.deathThisTick matches 1.. as @a[scores={blitz.alive=1}] if score @s blitz.death matches 1.. as @s run function stmc:games/blitz/helper/death_this_tick
...
execute as @a if score @s blitz.stats.respawn matches 1 in stmc:blitz run gamemode adventure @s
execute as @a[team=RED_RACCOONS] if score @s blitz.stats.respawn matches 1 in stmc:blitz run tp @s -36 107 100
execute as @a[team=ORANGE_OTTERS] if score @s blitz.stats.respawn matches 1 in stmc:blitz run tp @s -36 107 -100
execute as @a[team=PINK_PIKAS] if score @s blitz.stats.respawn matches 1 in stmc:blitz run tp @s 100 107 -36
execute as @a[team=YELLOW_YAKS] if score @s blitz.stats.respawn matches 1 in stmc:blitz run tp @s 100 107 36
execute as @a[team=GREEN_GOATS] if score @s blitz.stats.respawn matches 1 in stmc:blitz run tp @s 36 107 -100
execute as @a[team=CYAN_COUGARS] if score @s blitz.stats.respawn matches 1 in stmc:blitz run tp @s -100 107 -36
execute as @a[team=PURPLE_PENGUINS] if score @s blitz.stats.respawn matches 1 in stmc:blitz run tp @s -100 107 36
execute as @a[team=BLUE_BEARS] if score @s blitz.stats.respawn matches 1 in stmc:blitz run tp @s 36 107 100
