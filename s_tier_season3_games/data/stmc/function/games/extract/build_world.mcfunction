...
# slot 1-1
execute in stmc:extract if score .extractData .time matches 5 \
...
# slot 1-2
execute in stmc:extract if score .extractData .time matches 10 \
...
# slot 2-1
execute in stmc:extract if score .extractData .time matches 15 \
...
# slot 2-2
execute in stmc:extract if score .extractData .time matches 20 \
...
# slot 3-1
execute in stmc:extract if score .extractData .time matches 25 \
...
# slot 3-2
execute in stmc:extract if score .extractData .time matches 30 \
...
# slot 4-1
execute in stmc:extract if score .extractData .time matches 35 \
...
# slot 4-2
execute in stmc:extract if score .extractData .time matches 40 \
...
execute in stmc:extract if score .extractData .time matches 40 run function stmc:games/extract/helper/player_teleport with storage extract:map
