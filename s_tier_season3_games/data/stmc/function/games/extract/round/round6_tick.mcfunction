...
execute if score extract.handler extract.timer.game.round6 matches 1 run data merge storage extract:map {slot2:6}
execute if score extract.handler extract.timer.game.round6 matches 1 run data merge storage extract:map {slot3:2}
execute if score extract.handler extract.timer.game.round6 matches 1 run data merge storage extract:map {slot4:4}
execute if score extract.handler extract.timer.game.round6 matches 1 run data merge storage extract:map {slot5:3}
execute if score extract.handler extract.timer.game.round6 matches 1 run data merge storage extract:map {slot6:8}
execute if score extract.handler extract.timer.game.round6 matches 1 run data merge storage extract:map {slot7:5}
execute if score extract.handler extract.timer.game.round6 matches 1 run data merge storage extract:map {slot8:7}
...
execute if score extract.handler extract.timer.game.round6 matches 0..60 run function stmc:games/extract/build_world with storage extract:map
...
execute in stmc:extract if score extract.handler extract.timer.game.round6 matches 45..300 run effect clear @a
execute in stmc:extract if score extract.handler extract.timer.game.round6 matches ..300 run kill @e[type=item]
...
execute in stmc:extract if score extract.handler extract.timer.game.round6 matches 300 run fill -55 133 107 55 138 7 air replace red_stained_glass
execute in stmc:extract if score extract.handler extract.timer.game.round6 matches 300 run fill -55 133 107 55 138 7 air replace orange_stained_glass
execute in stmc:extract if score extract.handler extract.timer.game.round6 matches 300 run fill -55 133 107 55 138 7 air replace pink_stained_glass
execute in stmc:extract if score extract.handler extract.timer.game.round6 matches 300 run fill -55 133 107 55 138 7 air replace yellow_stained_glass
execute in stmc:extract if score extract.handler extract.timer.game.round6 matches 300 run fill -55 133 107 55 138 7 air replace green_stained_glass
execute in stmc:extract if score extract.handler extract.timer.game.round6 matches 300 run fill -55 133 107 55 138 7 air replace cyan_stained_glass
execute in stmc:extract if score extract.handler extract.timer.game.round6 matches 300 run fill -55 133 107 55 138 7 air replace purple_stained_glass
execute in stmc:extract if score extract.handler extract.timer.game.round6 matches 300 run fill -55 133 107 55 138 7 air replace blue_stained_glass
execute in stmc:extract if score extract.handler extract.timer.game.round6 matches 300 run fill -55 133 107 55 138 7 air replace barrier
execute in stmc:extract if score extract.handler extract.timer.game.round6 matches 300 run kill @e[type=armor_stand]
execute in stmc:extract if score extract.handler extract.timer.game.round6 matches 300 run kill @e[type=interaction]
