...
execute in stmc:extract if score extract.handler extract.timer.game.round matches 45..300 run effect clear @a
execute in stmc:extract if score extract.handler extract.timer.game.round matches ..300 run kill @e[type=item]

# countdown at 5 seconds
execute if score extract.handler extract.timer.game.round matches 200 run title @a actionbar {text:"5 seconds!",color:red,bold:true}
execute as @a at @s if score extract.handler extract.timer.game.round matches 200 run playsound minecraft:block.note_block.pling master @a ~ ~ ~ 0.8 1
execute if score extract.handler extract.timer.game.round matches 220 run title @a actionbar {text:"4 seconds!",color:red,bold:true}
execute as @a at @s if score extract.handler extract.timer.game.round matches 220 run playsound minecraft:block.note_block.pling master @a ~ ~ ~ 0.8 1.1
execute if score extract.handler extract.timer.game.round matches 240 run title @a actionbar {text:"3 seconds!",color:red,bold:true}
execute as @a at @s if score extract.handler extract.timer.game.round matches 240 run playsound minecraft:block.note_block.pling master @a ~ ~ ~ 0.8 1.2
execute if score extract.handler extract.timer.game.round matches 260 run title @a actionbar {text:"2 seconds!",color:red,bold:true}
execute as @a at @s if score extract.handler extract.timer.game.round matches 260 run playsound minecraft:block.note_block.pling master @a ~ ~ ~ 0.8 1.3
execute if score extract.handler extract.timer.game.round matches 280 run title @a actionbar {text:"1 second!",color:red,bold:true}
execute as @a at @s if score extract.handler extract.timer.game.round matches 280 run playsound minecraft:block.note_block.pling master @a ~ ~ ~ 0.8 1.4
execute if score extract.handler extract.timer.game.round matches 300 run title @a title {text:"Go!",color:red,bold:true}
execute as @a at @s if score extract.handler extract.timer.game.round matches 200 run playsound minecraft:block.note_block.pling master @a ~ ~ ~ 1 2

# start round after 15 seconds
execute in stmc:extract if score extract.handler extract.timer.game.round matches 300 run function stmc:games/extract/round/round_start

# kills & block breaks are automatically calculated by the game, so no need to check up on them

# track double points
execute if score extract.handler extract.timer.game.round matches 300..700 run function stmc:games/extract/helper/double_value

# announce end of double points
execute if score extract.handler extract.timer.game.round matches 700 run tellraw @a {text:"Double points ended.",color:red}
