...
execute in stmc:solve if score solve.handler solve.timer.game matches 1 run fill 18 97 8 18 98 148 air replace minecraft:netherite_block
...
execute unless score solve.YellowYaks solve.stats.players matches 1.. run scoreboard players set solve.YellowYaks solve.stats.players 1
...
execute unless score solve.BlueBears solve.stats.players matches 1.. run scoreboard players set solve.BlueBears solve.stats.players 1

# check for teams completing rooms
function stmc:games/solve/game_active/room_checks
...
scoreboard players operation solve.YellowYaks solve.timer.game.rooms += solve.YellowYaks solve.timer.game.room1
scoreboard players operation solve.YellowYaks solve.timer.game.rooms += solve.YellowYaks solve.timer.game.room2
scoreboard players operation solve.YellowYaks solve.timer.game.rooms += solve.YellowYaks solve.timer.game.room3
scoreboard players operation solve.YellowYaks solve.timer.game.rooms += solve.YellowYaks solve.timer.game.room4

scoreboard players set solve.BlueBears solve.timer.game.rooms 0
scoreboard players operation solve.BlueBears solve.timer.game.rooms += solve.BlueBears solve.timer.game.room1
scoreboard players operation solve.BlueBears solve.timer.game.rooms += solve.BlueBears solve.timer.game.room2
scoreboard players operation solve.BlueBears solve.timer.game.rooms += solve.BlueBears solve.timer.game.room3
scoreboard players operation solve.BlueBears solve.timer.game.rooms += solve.BlueBears solve.timer.game.room4
...
execute as @a[team=YELLOW_YAKS,gamemode=!spectator] if score solve.YellowYaks solve.stats.roomsCompleted matches 4 run gamemode spectator @s
...
execute as @a[team=BLUE_BEARS,gamemode=!spectator] if score solve.BlueBears solve.stats.roomsCompleted matches 4 run gamemode spectator @s
...
execute if score solve.YellowYaks solve.stats.roomsCompleted matches 4 run scoreboard players add solve.handler solve.stats.roomsCompleted 1
...
execute if score solve.BlueBears solve.stats.roomsCompleted matches 4 run scoreboard players add solve.handler solve.stats.roomsCompleted 1
