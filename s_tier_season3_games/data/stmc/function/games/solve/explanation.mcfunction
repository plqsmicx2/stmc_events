...
execute in stmc:solve if score solve.handler solve.timer.explanation matches 1 run tp @a 3 96 5 -60 25
...
# blurb #2
execute in stmc:solve if score solve.handler solve.timer.explanation matches 160 run tp @a 27 96 12 -190 15
...
# blurb #3
execute in stmc:solve if score solve.handler solve.timer.explanation matches 320 run tp @a 52 99 2 50 20
...
# blurb #4
execute in stmc:solve if score solve.handler solve.timer.explanation matches 480 run tp @a 67 96 13 -220 0
...
execute if score solve.handler solve.timer.explanation matches 480 run tellraw @a {text:" "}
execute if score solve.handler solve.timer.explanation matches 480 run tellraw @a [{text:"1st: +",color:"yellow"},{text:"160",color:"red"},{text:" points",color:"yellow"}]
execute if score solve.handler solve.timer.explanation matches 480 run tellraw @a [{text:"2nd: +",color:"yellow"},{text:"120",color:"red"},{text:" points",color:"yellow"}]
...
execute if score solve.handler solve.timer.explanation matches 480 run tellraw @a [{text:"4th: +",color:"yellow"},{text:"60",color:"red"},{text:" points",color:"yellow"}]
...
execute if score solve.handler solve.timer.explanation matches 480 run tellraw @a [{text:"6th: +",color:"yellow"},{text:"20",color:"red"},{text:" points",color:"yellow"}]
...
# blurb #5
execute in stmc:solve if score solve.handler solve.timer.explanation matches 640 run tp @a 80 97 3 -70 15
...
execute if score solve.handler solve.timer.explanation matches 640 run tellraw @a {text:" "}
execute if score solve.handler solve.timer.explanation matches 640 run tellraw @a [{text:"1st: +",color:"yellow"},{text:"48",color:"red"},{text:" points",color:"yellow"}]
execute if score solve.handler solve.timer.explanation matches 640 run tellraw @a [{text:"2nd: +",color:"yellow"},{text:"36",color:"red"},{text:" points",color:"yellow"}]
execute if score solve.handler solve.timer.explanation matches 640 run tellraw @a [{text:"3rd: +",color:"yellow"},{text:"24",color:"red"},{text:" points",color:"yellow"}]
...
execute if score solve.handler solve.timer.explanation matches 640 run tellraw @a [{text:"5th: +",color:"yellow"},{text:"8",color:"red"},{text:" points",color:"yellow"}]
execute if score solve.handler solve.timer.explanation matches 640 run tellraw @a [{text:"6th: +",color:"yellow"},{text:"0",color:"red"},{text:" points",color:"yellow"}]
...
# blurb #6
execute in stmc:solve as @a[team=RED_RACCOONS] if score solve.handler solve.timer.explanation matches 799 run tp @s 2 93 6 -90 0
execute in stmc:solve as @a[team=ORANGE_OTTERS] if score solve.handler solve.timer.explanation matches 799 run tp @s 2 93 26 -90 0
execute in stmc:solve as @a[team=PINK_PIKAS] if score solve.handler solve.timer.explanation matches 799 run tp @s 2 93 46 -90 0
execute in stmc:solve as @a[team=GREEN_GOATS] if score solve.handler solve.timer.explanation matches 799 run tp @s 2 93 66 -90 0
execute in stmc:solve as @a[team=CYAN_COUGARS] if score solve.handler solve.timer.explanation matches 799 run tp @s 2 93 86 -90 0
execute in stmc:solve as @a[team=PURPLE_PENGUINS] if score solve.handler solve.timer.explanation matches 799 run tp @s 2 93 106 -90 0
execute in stmc:solve as @a[team=YELLOW_YAKS] if score solve.handler solve.timer.explanation matches 799 run tp @s 2 93 126 -90 0
execute in stmc:solve as @a[team=BLUE_BEARS] if score solve.handler solve.timer.explanation matches 799 run tp @s 2 93 146 -90 0
execute in stmc:solve if score solve.handler solve.timer.explanation matches 799 run gamemode adventure @a
execute in stmc:solve if score solve.handler solve.timer.explanation matches 799 run gamemode spectator @a[team=SPECTATORS]
