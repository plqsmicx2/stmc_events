...
execute if score stmc.handler event.teamAssignment matches 1 run function stmc:thread/helper/teams/assign_teams
...
# before event perms
execute if score stmc.handler event.stage matches 0 if score stmc.handler event.paused matches 1 run function stmc:thread/pre_game
...
execute if score stmc.handler event.paused matches 0 run function stmc:thread/stage_tick