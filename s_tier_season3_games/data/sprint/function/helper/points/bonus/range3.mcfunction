...
# handles case #3: over 90 seconds

# set increment for range
scoreboard players set #math .secIncrement 6

# standardize to time range (get # over 90 seconds)
scoreboard players remove @s sprint.timer.remainder 1800
...
scoreboard players add @s sprint.points.bonus 25