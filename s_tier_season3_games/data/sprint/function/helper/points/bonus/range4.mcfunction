...
# handles case #4: over 180 seconds

# set increment for range
scoreboard players set #math .secIncrement 10

# standardize to time range (get # over 180 seconds)
scoreboard players remove @s sprint.timer.remainder 3600
...
scoreboard players add @s sprint.points.bonus 40