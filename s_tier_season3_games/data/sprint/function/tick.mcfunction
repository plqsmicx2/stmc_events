...
execute unless score sprint.handler sprint.stage matches 0.. run function sprint:load

# run functions every tick
function sprint:helper/points/points_update
function sprint:sidebar with storage stmc:global

# auto pause
execute unless score sprint.handler sprint.stage matches 3 run function thread:automatic_pause
...
# set spawn barrier
execute if score sprint.handler sprint.timer.delay1 matches 10 in sprint:sprint run fill -11 101 -2 -11 103 2 barrier
...
execute if score sprint.handler sprint.stage matches 1 run function sprint:explanation
...
execute if score sprint.handler sprint.stage matches 2 if score sprint.handler sprint.timer.delay2 matches 200.. run function sprint:helper/start_game
...
execute if score sprint.handler sprint.stage matches 3 run function sprint:game_tick with storage stmc:global
...
execute if score sprint.handler sprint.timer.delay3 matches 100 run function sprint:announcements/individual
execute if score sprint.handler sprint.timer.delay3 matches 300 run function sprint:announcements/team with storage stmc:global
execute if score sprint.handler sprint.stage matches 4 if score sprint.handler sprint.timer.delay3 matches 400.. run function sprint:reset