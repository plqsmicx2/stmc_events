...
execute in sprint:sprint if score sprint.handler sprint.timer.explanation matches 1 run tp @a -20 110 200 90 60
...
# blurb #2
execute in sprint:sprint if score sprint.handler sprint.timer.explanation matches 100 run tp @a -20 110 400 90 60
...
# blurb #3
execute in sprint:sprint if score sprint.handler sprint.timer.explanation matches 200 run tp @a -20 110 600 90 60
...
execute in sprint:sprint if score sprint.handler sprint.timer.explanation matches 300 run tp @a -1 102 0 90 0
