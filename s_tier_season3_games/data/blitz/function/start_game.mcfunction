...
# teleport players
execute as @a[team=RED_RACCOONS] in blitz:blitz run tp @s -36 107 100
execute as @a[team=ORANGE_OTTERS] in blitz:blitz run tp @s -36 107 -100
execute as @a[team=PINK_PIKAS] in blitz:blitz run tp @s 100 107 -36
execute as @a[team=YELLOW_YAKS] in blitz:blitz run tp @s 100 107 36
execute as @a[team=GREEN_GOATS] in blitz:blitz run tp @s 36 107 -100
execute as @a[team=CYAN_COUGARS] in blitz:blitz run tp @s -100 107 -36
execute as @a[team=PURPLE_PENGUINS] in blitz:blitz run tp @s -100 107 36
execute as @a[team=BLUE_BEARS] in blitz:blitz run tp @s 36 107 100

# set spawnpoints
execute as @a[team=RED_RACCOONS] in blitz:blitz run spawnpoint @s -36 107 100
execute as @a[team=ORANGE_OTTERS] in blitz:blitz run spawnpoint @s -36 107 -100
execute as @a[team=PINK_PIKAS] in blitz:blitz run spawnpoint @s 100 107 -36
execute as @a[team=YELLOW_YAKS] in blitz:blitz run spawnpoint @s 100 107 36
execute as @a[team=GREEN_GOATS] in blitz:blitz run spawnpoint @s 36 107 -100
execute as @a[team=CYAN_COUGARS] in blitz:blitz run spawnpoint @s -100 107 -36
execute as @a[team=PURPLE_PENGUINS] in blitz:blitz run spawnpoint @s -100 107 36
execute as @a[team=BLUE_BEARS] in blitz:blitz run spawnpoint @s 36 107 100

# summon villagers if anyone is on that team

# red team
execute if score blitz.RedRaccoons blitz.stats.players matches 1.. in blitz:blitz run summon villager -40 105 106 {NoGravity:1b,Silent:1b,Invulnerable:1b,CustomNameVisible:1b,PersistenceRequired:1b,NoAI:1b, \ 
...
execute if score blitz.RedRaccoons blitz.stats.players matches 1.. in blitz:blitz run summon villager -40 105 105 {NoGravity:1b,Silent:1b,Invulnerable:1b,CustomNameVisible:1b,PersistenceRequired:1b,NoAI:1b, \ 
...
# orange team
execute if score blitz.OrangeOtters blitz.stats.players matches 1.. in blitz:blitz run summon villager -40 105 -106 {NoGravity:1b,Silent:1b,Invulnerable:1b,CustomNameVisible:1b,PersistenceRequired:1b,NoAI:1b, \ 
        CustomName:{"color":"red","text":"Weaponry"}, \ 
        active_effects:[{id:"minecraft:resistance",amplifier:10,duration:-1,show_particles:0b}], \ 
        Offers:{Recipes:[ \ 
        {rewardExp:0b,maxUses:999999,uses:0,buy:{id:"minecraft:iron_ingot",count:1},sell:{id:"minecraft:stone_sword",count:1,components:{"minecraft:custom_data":{replace:1b}}}}, \ 
        ...
        {rewardExp:0b,maxUses:999999,uses:0,buy:{id:"minecraft:gold_ingot",count:4},sell:{id:"minecraft:iron_leggings",count:1,components:{"minecraft:custom_data":{replace:1b}}}}, \ 
        {rewardExp:0b,maxUses:999999,uses:0,buy:{id:"minecraft:emerald",count:4},sell:{id:"minecraft:diamond_leggings",count:1,components:{"minecraft:custom_data":{replace:1b}}}},]}}
execute if score blitz.OrangeOtters blitz.stats.players matches 1.. in blitz:blitz run summon villager -40 105 -105 {NoGravity:1b,Silent:1b,Invulnerable:1b,CustomNameVisible:1b,PersistenceRequired:1b,NoAI:1b, \ 
        CustomName:{"color":"green","text":"Tools"}, \ 
        active_effects:[{id:"minecraft:resistance",amplifier:10,duration:-1,show_particles:0b}], \ 
        Offers:{Recipes:[ \ 
...
# pink team
execute if score blitz.PinkPikas blitz.stats.players matches 1.. in blitz:blitz run summon villager 106 105 -40 {NoGravity:1b,Silent:1b,Invulnerable:1b,CustomNameVisible:1b,PersistenceRequired:1b,NoAI:1b, \ 
        CustomName:{"color":"red","text":"Weaponry"}, \ 
        active_effects:[{id:"minecraft:resistance",amplifier:10,duration:-1,show_particles:0b}], \ 
        Offers:{Recipes:[ \ 
        {rewardExp:0b,maxUses:999999,uses:0,buy:{id:"minecraft:iron_ingot",count:1},sell:{id:"minecraft:stone_sword",count:1,components:{"minecraft:custom_data":{replace:1b}}}}, \ 
        ...
        {rewardExp:0b,maxUses:999999,uses:0,buy:{id:"minecraft:gold_ingot",count:4},sell:{id:"minecraft:iron_leggings",count:1,components:{"minecraft:custom_data":{replace:1b}}}}, \ 
        {rewardExp:0b,maxUses:999999,uses:0,buy:{id:"minecraft:emerald",count:4},sell:{id:"minecraft:diamond_leggings",count:1,components:{"minecraft:custom_data":{replace:1b}}}},]}}
execute if score blitz.PinkPikas blitz.stats.players matches 1.. in blitz:blitz run summon villager 105 105 -40 {NoGravity:1b,Silent:1b,Invulnerable:1b,CustomNameVisible:1b,PersistenceRequired:1b,NoAI:1b, \ 
        CustomName:{"color":"green","text":"Tools"}, \ 
        active_effects:[{id:"minecraft:resistance",amplifier:10,duration:-1,show_particles:0b}], \ 
        Offers:{Recipes:[ \ 
...
# yellow team
execute if score blitz.YellowYaks blitz.stats.players matches 1.. in blitz:blitz run summon villager 106 105 40 {NoGravity:1b,Silent:1b,Invulnerable:1b,CustomNameVisible:1b,PersistenceRequired:1b,NoAI:1b, \ 
        CustomName:{"color":"red","text":"Weaponry"}, \ 
        active_effects:[{id:"minecraft:resistance",amplifier:10,duration:-1,show_particles:0b}], \ 
        Offers:{Recipes:[ \ 
        {rewardExp:0b,maxUses:999999,uses:0,buy:{id:"minecraft:iron_ingot",count:1},sell:{id:"minecraft:stone_sword",count:1,components:{"minecraft:custom_data":{replace:1b}}}}, \ 
        ...
        {rewardExp:0b,maxUses:999999,uses:0,buy:{id:"minecraft:gold_ingot",count:4},sell:{id:"minecraft:iron_leggings",count:1,components:{"minecraft:custom_data":{replace:1b}}}}, \ 
        {rewardExp:0b,maxUses:999999,uses:0,buy:{id:"minecraft:emerald",count:4},sell:{id:"minecraft:diamond_leggings",count:1,components:{"minecraft:custom_data":{replace:1b}}}},]}}
execute if score blitz.YellowYaks blitz.stats.players matches 1.. in blitz:blitz run summon villager 105 105 40 {NoGravity:1b,Silent:1b,Invulnerable:1b,CustomNameVisible:1b,PersistenceRequired:1b,NoAI:1b, \ 
        CustomName:{"color":"green","text":"Tools"}, \ 
        active_effects:[{id:"minecraft:resistance",amplifier:10,duration:-1,show_particles:0b}], \ 
        Offers:{Recipes:[ \ 
...
# green team
execute if score blitz.GreenGoats blitz.stats.players matches 1.. in blitz:blitz run summon villager 40 105 -106 {NoGravity:1b,Silent:1b,Invulnerable:1b,CustomNameVisible:1b,PersistenceRequired:1b,NoAI:1b, \ 
        CustomName:{"color":"red","text":"Weaponry"}, \ 
        active_effects:[{id:"minecraft:resistance",amplifier:10,duration:-1,show_particles:0b}], \ 
        Offers:{Recipes:[ \ 
        {rewardExp:0b,maxUses:999999,uses:0,buy:{id:"minecraft:iron_ingot",count:1},sell:{id:"minecraft:stone_sword",count:1,components:{"minecraft:custom_data":{replace:1b}}}}, \ 
        ...
        {rewardExp:0b,maxUses:999999,uses:0,buy:{id:"minecraft:gold_ingot",count:4},sell:{id:"minecraft:iron_leggings",count:1,components:{"minecraft:custom_data":{replace:1b}}}}, \ 
        {rewardExp:0b,maxUses:999999,uses:0,buy:{id:"minecraft:emerald",count:4},sell:{id:"minecraft:diamond_leggings",count:1,components:{"minecraft:custom_data":{replace:1b}}}},]}}
execute if score blitz.GreenGoats blitz.stats.players matches 1.. in blitz:blitz run summon villager 40 105 -105 {NoGravity:1b,Silent:1b,Invulnerable:1b,CustomNameVisible:1b,PersistenceRequired:1b,NoAI:1b, \ 
        CustomName:{"color":"green","text":"Tools"}, \ 
        active_effects:[{id:"minecraft:resistance",amplifier:10,duration:-1,show_particles:0b}], \ 
        Offers:{Recipes:[ \ 
...
# cyan team
execute if score blitz.CyanCougars blitz.stats.players matches 1.. in blitz:blitz run summon villager -106 105 -40 {NoGravity:1b,Silent:1b,Invulnerable:1b,CustomNameVisible:1b,PersistenceRequired:1b,NoAI:1b, \ 
        CustomName:{"color":"red","text":"Weaponry"}, \ 
        active_effects:[{id:"minecraft:resistance",amplifier:10,duration:-1,show_particles:0b}], \ 
        Offers:{Recipes:[ \ 
        {rewardExp:0b,maxUses:999999,uses:0,buy:{id:"minecraft:iron_ingot",count:1},sell:{id:"minecraft:stone_sword",count:1,components:{"minecraft:custom_data":{replace:1b}}}}, \ 
        ...
        {rewardExp:0b,maxUses:999999,uses:0,buy:{id:"minecraft:gold_ingot",count:4},sell:{id:"minecraft:iron_leggings",count:1,components:{"minecraft:custom_data":{replace:1b}}}}, \ 
        {rewardExp:0b,maxUses:999999,uses:0,buy:{id:"minecraft:emerald",count:4},sell:{id:"minecraft:diamond_leggings",count:1,components:{"minecraft:custom_data":{replace:1b}}}},]}}
execute if score blitz.CyanCougars blitz.stats.players matches 1.. in blitz:blitz run summon villager -105 105 -40 {NoGravity:1b,Silent:1b,Invulnerable:1b,CustomNameVisible:1b,PersistenceRequired:1b,NoAI:1b, \ 
        CustomName:{"color":"green","text":"Tools"}, \ 
        active_effects:[{id:"minecraft:resistance",amplifier:10,duration:-1,show_particles:0b}], \ 
        Offers:{Recipes:[ \ 
...
# purple team
execute if score blitz.PurplePenguins blitz.stats.players matches 1.. in blitz:blitz run summon villager -106 105 40 {NoGravity:1b,Silent:1b,Invulnerable:1b,CustomNameVisible:1b,PersistenceRequired:1b,NoAI:1b, \ 
        CustomName:{"color":"red","text":"Weaponry"}, \ 
        active_effects:[{id:"minecraft:resistance",amplifier:10,duration:-1,show_particles:0b}], \ 
        Offers:{Recipes:[ \ 
        {rewardExp:0b,maxUses:999999,uses:0,buy:{id:"minecraft:iron_ingot",count:1},sell:{id:"minecraft:stone_sword",count:1,components:{"minecraft:custom_data":{replace:1b}}}}, \ 
        ...
        {rewardExp:0b,maxUses:999999,uses:0,buy:{id:"minecraft:gold_ingot",count:4},sell:{id:"minecraft:iron_leggings",count:1,components:{"minecraft:custom_data":{replace:1b}}}}, \ 
        {rewardExp:0b,maxUses:999999,uses:0,buy:{id:"minecraft:emerald",count:4},sell:{id:"minecraft:diamond_leggings",count:1,components:{"minecraft:custom_data":{replace:1b}}}},]}}
execute if score blitz.PurplePenguins blitz.stats.players matches 1.. in blitz:blitz run summon villager -105 105 40 {NoGravity:1b,Silent:1b,Invulnerable:1b,CustomNameVisible:1b,PersistenceRequired:1b,NoAI:1b, \ 
        CustomName:{"color":"green","text":"Tools"}, \ 
        active_effects:[{id:"minecraft:resistance",amplifier:10,duration:-1,show_particles:0b}], \ 
        Offers:{Recipes:[ \ 
...
# blue team
execute if score blitz.BlueBears blitz.stats.players matches 1.. in blitz:blitz run summon villager 40 105 106 {NoGravity:1b,Silent:1b,Invulnerable:1b,CustomNameVisible:1b,PersistenceRequired:1b,NoAI:1b, \ 
        CustomName:{"color":"red","text":"Weaponry"}, \ 
        active_effects:[{id:"minecraft:resistance",amplifier:10,duration:-1,show_particles:0b}], \ 
        Offers:{Recipes:[ \ 
        {rewardExp:0b,maxUses:999999,uses:0,buy:{id:"minecraft:iron_ingot",count:1},sell:{id:"minecraft:stone_sword",count:1,components:{"minecraft:custom_data":{replace:1b}}}}, \ 
        ...
        {rewardExp:0b,maxUses:999999,uses:0,buy:{id:"minecraft:gold_ingot",count:4},sell:{id:"minecraft:iron_leggings",count:1,components:{"minecraft:custom_data":{replace:1b}}}}, \ 
        {rewardExp:0b,maxUses:999999,uses:0,buy:{id:"minecraft:emerald",count:4},sell:{id:"minecraft:diamond_leggings",count:1,components:{"minecraft:custom_data":{replace:1b}}}},]}}
execute if score blitz.BlueBears blitz.stats.players matches 1.. in blitz:blitz run summon villager 40 105 105 {NoGravity:1b,Silent:1b,Invulnerable:1b,CustomNameVisible:1b,PersistenceRequired:1b,NoAI:1b, \ 
        CustomName:{"color":"green","text":"Tools"}, \ 
        active_effects:[{id:"minecraft:resistance",amplifier:10,duration:-1,show_particles:0b}], \ 
        Offers:{Recipes:[ \ 
