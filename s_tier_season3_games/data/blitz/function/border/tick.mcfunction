...
execute in blitz:blitz if score blitz.handler blitz.timer.game matches 1 run kill @e[type=armor_stand]
execute in blitz:blitz if score blitz.handler blitz.timer.game matches 1 run summon armor_stand 0 90 0 {Rotation:[0F,0F],NoGravity:1b,Silent:1b,Invulnerable:1b,HasVisualFire:0b,Glowing:0b,Invisible:1b,Tags:["blitz.worldborder.center1","blitz.worldborder.centerVisual"]}
execute in blitz:blitz if score blitz.handler blitz.timer.game matches 1 run summon armor_stand 0 90 0 {Rotation:[0F,90F],NoGravity:1b,Silent:1b,Invulnerable:1b,HasVisualFire:0b,Glowing:0b,Invisible:1b,Tags:["blitz.worldborder.center2","blitz.worldborder.centerVisual"]}
execute in blitz:blitz if score blitz.handler blitz.timer.game matches 1 run summon armor_stand 0 90 0 {Rotation:[0F,180F],NoGravity:1b,Silent:1b,Invulnerable:1b,HasVisualFire:0b,Glowing:0b,Invisible:1b,Tags:["blitz.worldborder.center3","blitz.worldborder.centerVisual"]}
execute in blitz:blitz if score blitz.handler blitz.timer.game matches 1 run summon armor_stand 0 90 0 {Rotation:[0F,270F],NoGravity:1b,Silent:1b,Invulnerable:1b,HasVisualFire:0b,Glowing:0b,Invisible:1b,Tags:["blitz.worldborder.center4","blitz.worldborder.centerVisual"]}
...
execute if score blitz.handler blitz.borderStage matches 0 run function blitz:border/damage {radius:200, damage:0.2}
...
execute in blitz:blitz if score blitz.handler blitz.borderStage matches 1 run function blitz:border/damage with storage survival_games:data
...
execute in blitz:blitz if score blitz.handler blitz.borderStage matches 2 run function blitz:border/damage with storage survival_games:data
...
execute if score blitz.handler blitz.borderStage matches 3 run function blitz:border/damage {radius:0, damage:0.75}