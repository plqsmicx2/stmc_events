...
execute if score @s race.laps_completed matches 0..3 run scoreboard players add @s race.laptime.tick 1

execute if score @s race.laps_completed matches 0..3 if score @s race.laptime.tick matches 20 run scoreboard players add @s race.laptime.seconds 1
execute if score @s race.laps_completed matches 0..3 if score @s race.laptime.tick matches 20 run scoreboard players set @s race.laptime.tick 0

execute if score @s race.laps_completed matches 0..3 if score @s race.laptime.seconds matches 60 run scoreboard players add @s race.laptime.mins 1
execute if score @s race.laps_completed matches 0..3 if score @s race.laptime.seconds matches 60 run scoreboard players set @s race.laptime.seconds 0
...
execute unless score @s race.laps_completed matches 4.. as @s run function race:checkpoint_update
...
execute in race:race at @s if score @s race.checkpoints_completed matches 8 if entity @s[x=-17,dx=-100] run tp @s -14 126 -10
execute in race:race at @s if score @s race.checkpoints_completed matches 8 if entity @s[z=57,dz=50] run tp @s -14 126 -10
execute in race:race at @s if score @s race.checkpoints_completed matches 8 if entity @s[x=-11,dx=100,z=-7,dz=-50] run tp @s -14 126 -10
execute in race:race at @s if score @s race.checkpoints_completed matches 8 if entity @s[x=57,dx=50] run tp @s -14 126 -10

# grant trident
execute in race:race as @s[x=67,y=115,z=47,dx=1,dy=5,dz=5] run item replace entity @s hotbar.0 with minecraft:trident[enchantments={"riptide":2}]

# run reset on players once they complete
execute if score @s race.laps_completed matches 4.. as @s run function race:reset
...
execute if score @s race.laps_completed matches 4.. unless score @s race.completion.rank matches 1.. run scoreboard players operation @s race.completion.rank = race.handler race.players_completed