...
# interaction check
execute in trials:lobby as @e[tag=replicate] on target run function stmc:games/trials/replicate/teleport
execute in trials:lobby as @e[tag=scramble] on target run function stmc:games/trials/scramble/teleport
execute in trials:lobby as @e[tag=spleef] on target run function stmc:games/trials/spleef/teleport
execute in trials:lobby as @e[tag=towers] on target run function stmc:games/trials/towers/teleport
