...
# set arena
execute in stmc:extract/main run clone -20 -3 -32 20 29 22 30 98 -27

# teleport players
execute as @a in stmc:extract/main if entity @s[x=3,y=99,z=-1,dx=2,dy=5,dz=-1] run tp @s 50 102 -24 0 0
execute as @a in stmc:extract/main if entity @s[x=3,y=99,z=1,dx=2,dy=5,dz=1] run tp @s 50 102 24 180 0
...
execute in stmc:extract/main run function stmc:games/extract/generate_armor_stands